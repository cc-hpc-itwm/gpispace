...
namespace we
{
  namespace mgmt
  {
    ...
    */
    ...
    public:
      virtual void handle_internally (activity_t&, net_t&) = 0;
      virtual void handle_internally (activity_t&, mod_t&) = 0;
      virtual void handle_internally (activity_t&, expr_t&) = 0;
      virtual void handle_externally (activity_t&, net_t&) = 0;
      virtual void handle_externally (activity_t&, mod_t&) = 0;
      virtual void handle_externally (activity_t&, expr_t&) = 0;
