...
namespace we { namespace type {
  struct module_call_t
  {
    ...
    module_call_t
      ...
      , std::unordered_map<std::string, memory_buffer_info>&& memory_buffers
    ...
    std::unordered_map<std::string, memory_buffer_info> const& memory_buffers() const
    {
    ...
    std::unordered_map<std::string, memory_buffer_info> _memory_buffers;
