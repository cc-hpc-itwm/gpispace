...
{
  template<typename U>
    std::optional<U> fmap ( U (*f)(std::string const&)
                              , std::optional<std::string> const& m
                              )
  {
    if (m)
    {
...
// ************************************************************************* //
  ...
  namespace gspc::xml::parse
  {
    namespace
    {
      ...
      void property_map_type ( ::gspc::we::type::property::type&
                             , const xml_node_type*
                             , state::type&
                             );
      ...
      ::gspc::we::type::property::type properties_include
        (std::string const& file, state::type& state)
      {
        return generic_include<::gspc::we::type::property::type>
      ...
      {
        std::optional<::gspc::we::type::eureka_id_type> const& eureka_group
          (multi_mod.eureka_id());
      ...
      type::connect_type connect_type ( const xml_node_type* node
                                      , state::type& state
                                      , ::gspc::we::edge::type const& direction
                                      )
      {
        ...
        )
      {
            ...
            )
        {
          ...
          if (child)
          {
            ...
            {
              global = gspc::util::join (parse_cdata (child, state), ';').string();
            }
            else if (child_name == "local")
            {
              local = gspc::util::join (parse_cdata (child, state), ';').string();
            }
            else
            {
              state.warn
        ...
        (const xml_node_type* node, state::type& state)
      {
        return memory_transfer<type::memory_get>
          ...
          , [] ( const xml_node_type* node_
               ...
               , std::optional<bool> const& // ignored
                                                  ...
                                                  )
      {
            ...
            )
        {
          ...
          if (child)
          {
            ...
            {
              size = gspc::util::join (parse_cdata (child, state), ';').string();
            }
            else if (child_name == "alignment")
            {
              alignment = gspc::util::join (parse_cdata (child, state), ';').string();
            }
            else
            {
              state.warn
        ...
        return type::memory_buffer_type
          ...
          , name
          , *size
          , alignment.value_or ("1UL")
          , fmap<bool>
            (gspc::util::read_bool, optional (node, "read-only"))
          , properties
          );
      }
      ...
      {
        std::optional<type::function_type> function;
        std::optional<type::use_type> use;
          ...
          if (child)
          {
            ...
            else if (child_name == "connect-in")
            {
              connections.push<error::duplicate_connect>
                (connect_type (child, state, ::gspc::we::edge::PT{}));
            }
            else if (child_name == "connect-out")
            {
              connections.push<error::duplicate_connect>
                (connect_type (child, state, ::gspc::we::edge::TP{}));
            }
            ...
            {
              connections.push<error::duplicate_connect>
                (connect_type (child, state, ::gspc::we::edge::TP_MANY{}));
            }
            else if (child_name == "connect-read")
            {
              connections.push<error::duplicate_connect>
                (connect_type (child, state, ::gspc::we::edge::PT_READ{}));
            }
            else if (child_name == "connect-number-of-tokens")
            {
              connections.push<error::duplicate_connect>
                (connect_type (child, state, ::gspc::we::edge::PT_NUMBER_OF_TOKENS{}));
            }
            ...
            {
              const ::gspc::we::type::property::type deeper
...
#define TRANSITION(_function_or_use) type::transition_type                 \
          ...
          , conditions                                                     \
          , requirements                                                   \
          , fmap<::gspc::we::priority_type>                                        \
            ( ::boost::lexical_cast<::gspc::we::priority_type>                       \
            , optional (node, "priority")                                  \
            )                                                              \
          , fmap<bool>                                                     \
            (gspc::util::read_bool, optional (node, "inline"))              \
          , fmap<bool>                                                     \
            (gspc::util::read_bool, optional (node, "produce_shared"))      \
          , fmap<bool>                                                     \
            (gspc::util::read_bool, optional (node, "consume_shared"))      \
          , fmap<bool>                                                     \
            (gspc::util::read_bool, optional (node, "passthrough_shared"))  \
          , properties                                                     \
          }
...
#undef TRANSITION
            ...
            if (child_name == "property")
            {
              ...
              if (not value)
              {
                if (cdata.empty())
                {
                  util::property::set_state
                    ...
                    , prop
                    , state.prop_path()
                    , ::gspc::we::type::property::value_type()
                    );
                }
                else
                {
                  util::property::set_state
                    ...
                    , prop
                    , state.prop_path()
                    , gspc::pnet::type::value::read (cdata.front())
                    );
                }
              }
              else
              {
                ...
                util::property::set_state ( state
                                          , prop
                                          , state.prop_path()
                                          , gspc::pnet::type::value::read (*value)
                                          );
              }
      ...
      void property_map_type ( ::gspc::we::type::property::type& prop
                             , const xml_node_type* node
                             , state::type& state
                             )
      {
      ...
      {
        std::optional<type::function_type> fun;
        type::tmpl_type::names_type template_parameter;
        std::optional<std::string> name (optional (node, "name"));
      ...
      namespace
      {
        ...
        parse_function_signature
          ...
          , fhgpnet::util::unique<type::memory_buffer_type> const& memory_buffers
          ...
          )
        {
          auto&& is_known_port
            ( [&ports] (std::string const& name)
              {
                return ports.has ({name, ::gspc::we::type::port::direction::In{}})
                  || ports.has ({name, ::gspc::we::type::port::direction::Out{}});
              }
            );
          ...
          std::optional<std::string> memory_buffer_return;
        ...
        )
      {
        ...
        const std::optional<bool> pass_context
          (fmap<bool>
          (gspc::util::read_bool, optional (node, "pass_context")));
        const std::optional<bool> require_function_unloads_without_rest
          ( fmap<bool>
              ( gspc::util::read_bool
              , optional (node, "require_function_unloads_without_rest")
              )
          );
        const std::optional<bool> require_module_unloads_without_rest
          ( fmap<bool>
              ( gspc::util::read_bool
        ...
        const std::optional<std::string> port_return (std::get<1> (sig));
        const std::list<std::string> port_arg (std::get<2> (sig));
        const std::optional<std::string> memory_buffer_return
          (std::get<3> (sig));
        const std::list<std::string> memory_buffer_arg (std::get<4> (sig));

        std::optional<std::string> code;
        std::optional<util::position_type> pod_of_code;
        std::list<std::string> cincludes;
        std::list<std::string> ldflags;
        if (pass_context.value_or (false))
        {
          ldflags.emplace_back ("-lgspc_worker_context");
        }
            ...
            )
        {
          ...
          if (child)
          {
            ...
            else if (child_name == "code")
            {
              ...
              code = gspc::util::join (parse_cdata (child, state), '\n').string();
            }
        ...
        if (got_eureka_attribute)
        {
          ...
          gspc::pnet::type::value::value_type const value (*eureka_id);
          oss << gspc::pnet::type::value::show (value);
          eureka_id = oss.str();
        }
        ...
        return type::module_type
          ...
          , pass_context
          , eureka_id
          , require_function_unloads_without_rest.value_or (true)
          , require_module_unloads_without_rest.value_or (true)
          );
      }
                                  ...
                                  )
      {
        ...
        type::place_type place
          ...
          , fmap<bool>
              (gspc::util::read_bool, optional (node, "virtual"))
          , fmap<bool>
              (gspc::util::read_bool, optional (node, "put_token"))
          , fmap<bool>
              (gspc::util::read_bool, optional (node, "shared_sink"))
          , fmap<bool>
              (gspc::util::read_bool, optional (node, "generator"))
          );

        if (  place.is_virtual()
           && !ports.has ({place.name(), ::gspc::we::type::port::direction::Tunnel{}})
           )
        {
          state.warn
      ...
      std::tuple<type::multi_module_type, type::preferences_type>
        modules_type ( xml_node_type const* node
                     , state::type& state
                     , type::function_type::ports_type const& ports
                     , fhgpnet::util::unique<type::memory_buffer_type> const&
                         memory_buffers
                     )
      {
        type::multi_module_type modules;
        std::optional<type::preferences_type> preferences;
        ...
        function_type (const xml_node_type* node, state::type& state)
      {
        ...
        fhgpnet::util::unique<type::memory_buffer_type> memory_buffers;
        ...
        std::optional<type::expression_type> expression;
        std::optional<type::module_type> module;
        std::optional<type::net_type> net;
          ...
          if (child)
          {
            if (child_name == "in")
            {
              ports.push<error::duplicate_port>
                (port_type (child, state, ::gspc::we::type::port::direction::In{}));
            }
            else if (child_name == "out")
            {
              ports.push<error::duplicate_port>
                (port_type (child, state, ::gspc::we::type::port::direction::Out{}));
            }
            ...
            {
              ports.push<error::duplicate_port>
                (port_type (child, state, ::gspc::we::type::port::direction::Tunnel{}));
            }
...
#undef FUNCTION
        ...
        structure_type (const xml_node_type* node, state::type& state)
      {
        ...
        gspc::pnet::type::signature::structure_type s;
    ...
    type::function_type just_parse
      (state::type& state, std::filesystem::path const& input)
    {
                  ...
                  )
    {
      ...
      gspc::util::xml::xmlstream s (stream);
      ...
      )
    {
      ...
      // Auto-detect shared tracking from port signatures
      auto track_shared {::gspc::we::type::track_shared{}};

      for (type::port_type const& port : function.ports())
      {
        if (gspc::pnet::type::signature::contains_shared (port.signature()))
        {
          if (port.is_input())
          {
            track_shared.input = true;
          }
          else if (port.is_output())
          {
            track_shared.output = true;
          }
        }
      }
