...
{
  std::string const href (fhg::util::testing::random_string());
  ...
  std::string const prefix (fhg::util::testing::random_string());
...
{
  std::string const href (fhg::util::testing::random_string());
  std::string const prefix (fhg::util::testing::random_string_without ("${}"));
...
namespace
{
  ...
  {
    return fhg::util::testing::random_string_without ("${}\\");
  }
}
