...
//! \todo remove, needed to make ::gspc::we::type::net_type a complete type
...
#include <optional>
    ...
    namespace gspc::xml::parse::type
    {
      ...
      {
        gspc_assert (!(_port_return && _memory_buffer_return));
      ...
      std::optional<std::string> const& module_type::port_return() const
      {
        return _port_return;
      }
      ...
      std::optional<std::string> const& module_type::code() const
      {
        return _code;
      }
      ...
      std::optional<std::string> const& module_type::target() const
      {
        return _target;
      }
      std::optional<::gspc::we::type::eureka_id_type> const& module_type::eureka_id() const
      {
        return _eureka_id;
      }
      ...
      void module_type::specialize (type_map_type const& type_map)
      {
        if (!type_map.empty())
        {
          _function += gspc::util::print_container
            ( "_", "_", "", type_map
      ...
      namespace dump
      {
        ...
        void dump (::gspc::util::xml::xmlstream& s, module_type const& m)
        {
          s.open ("module");
          s.attr ("name", m.name());
