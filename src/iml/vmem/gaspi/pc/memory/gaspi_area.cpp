...
#include <string>
    ...
    namespace gpi::pc::memory
    {
      gaspi_area_t::gaspi_area_t ( gpi::pc::global::itopology_t & topology
                                 ...
                                 , gspc::iml::vmem::gaspi_timeout& time_left
      ...
      void *
      gaspi_area_t::raw_ptr (gspc::iml::MemoryOffset off)
      {
        return
                                  ...
                                  ) const
      {
        ...
        gspc::iml::MemoryOffset my_begin =  my_rank        * hdl.local_size;
        gspc::iml::MemoryOffset my_end   = (my_rank + 1ul) * hdl.local_size;
      ...
      gspc::iml::MemorySize
      gaspi_area_t::get_local_size ( gspc::iml::MemorySize size
      ...
      namespace helper
      {
        namespace
        {
          ...
          api::gaspi_t::transfers_t split_by_rank
            ( gspc::iml::MemorySize local_offset
            , gspc::iml::MemorySize remote_base
            , gspc::iml::MemorySize offset
            , gspc::iml::MemorySize per_node_size
          ...
          void dma_read_and_wait_for_readable
            ...
            , gspc::iml::MemorySize src_offset
            , gpi::pc::type::handle::descriptor_t const& dst_hdl
            , gspc::iml::MemorySize dst_offset
            , gspc::iml::MemorySize amount
            , api::gaspi_t& gaspi
            )
          {
        ...
        void do_send ( area_t & src_area
                     , gspc::iml::MemoryLocation src_loc
                     , gaspi_area_t & dst_area
                     , gspc::iml::MemoryLocation dst_loc
                     , gspc::iml::MemorySize amount
                     ...
                     )
        {
          ...
          gspc::iml::MemorySize remaining = amount;
          while (remaining)
          {
            buf.used (0);

            const gspc::iml::MemorySize to_send =
              std::min (remaining, buf.size ());

            const gspc::iml::MemorySize read_bytes =
                     ...
                     )
        {
          ...
          while (remaining)
          {
            ...
            const gspc::iml::MemorySize to_recv =
              std::min (remaining, buf.size ());
            ...
            const gspc::iml::MemorySize written_bytes =
      ...
      namespace
      {
        gspc::iml::MemorySize size_of_intersection
          ( gspc::iml::MemoryOffset a_begin, gspc::iml::MemorySize a_size
          , gspc::iml::MemoryOffset b_begin, gspc::iml::MemorySize b_size
          )
        {
      ...
      double gaspi_area_t::get_transfer_costs ( gspc::iml::MemoryRegion const& transfer
                                              , gpi::rank_t rank
                                              ) const
      {
      ...
      area_ptr_t gaspi_area_t::create
        ( gspc::iml::gaspi::SegmentDescription const& description
      ...
      {
        gspc::iml::MemorySize comsize = description.communication_buffer_size;
        gspc::iml::MemorySize numbuf = description.communication_buffer_count;
        gspc::iml::MemorySize const per_node_size
          ( gspc::util::divru (total_size, gaspi_context.number_of_nodes())
          + comsize * numbuf
          );

        //! \todo get from user? use for other areas as well? remove?
        gspc::iml::vmem::gaspi_timeout time_left (std::chrono::seconds (30));
