...
#include <gspc/iml/vmem/gaspi/pc/memory/gaspi_area.hpp>
...
#include <utility>
    ...
    namespace gpi::pc::memory
    {
      namespace
      {
        area_ptr_t create_area ( gspc::iml::SegmentDescription const& description
        ...
        {
          return gspc::util::visit<area_ptr_t>
            ( description
            , [&] (gspc::iml::gaspi::SegmentDescription const& desc)
              {
            ...
            , [&] (gspc::iml::beegfs::SegmentDescription const& desc)
              {
      ...
      manager_t::manager_t (gspc::iml::vmem::gaspi_context& gaspi_context)
                ...
                ( [this]
                  {
                    ...
                    catch (decltype (_tasks)::interrupted const& interrupted)
                    {
        ...
        manager_t::existing_segments() const
      {
        ...
        std::unordered_set<gspc::iml::SegmentHandle> result;
      ...
      std::unordered_set<gspc::iml::AllocationHandle>
        manager_t::existing_allocations (gspc::iml::SegmentHandle segment) const
      {
        lock_type const lock (m_mutex);
          ...
          )
      {
        ...
        return gspc::iml::SharedMemoryAllocationHandle {allocation};
      }

      void
      manager_t::unregister_memory ( gpi::pc::type::process_id_t pid
                                   , gspc::iml::SharedMemoryAllocationHandle hdl
                                   )
      {
        lock_type lock (m_mutex);
      ...
      void manager_t::add_area
        (gspc::iml::SegmentHandle seg_id, manager_t::area_ptr area)
      {
        lock_type const lock (m_mutex);
      ...
      manager_t::area_ptr
      manager_t::get_area (gspc::iml::SegmentHandle mem_id)
      {
        return static_cast<const manager_t*>(this)->get_area (mem_id);
      }

      manager_t::area_ptr
      manager_t::get_area (gspc::iml::SegmentHandle mem_id) const
      {
        lock_type lock (m_mutex);
      ...
      manager_t::area_ptr
        manager_t::get_area_by_handle (gspc::iml::AllocationHandle hdl)
      {
        return static_cast<const manager_t*>(this)->get_area_by_handle(hdl);
      }

      manager_t::area_ptr
        manager_t::get_area_by_handle (gspc::iml::AllocationHandle hdl) const
      {
        lock_type lock (m_mutex);
      ...
      void
        manager_t::add_handle ( gspc::iml::AllocationHandle hdl
      ...
      void
        manager_t::del_handle (gspc::iml::AllocationHandle hdl)
      {
        lock_type lock (m_mutex);
        if (m_handle_to_segment.find (hdl) == m_handle_to_segment.end())
        {
      ...
      void
      manager_t::remote_alloc ( gspc::iml::SegmentHandle seg_id
      ...
      manager_t::alloc ( gspc::iml::SegmentHandle seg_id
                       , gspc::iml::MemorySize size
      ...
      void
        manager_t::remote_free (gspc::iml::AllocationHandle hdl)
      {
        area_ptr area (get_area_by_handle (hdl));
      ...
      void
        manager_t::free (gspc::iml::AllocationHandle hdl)
      {
        area_ptr area (get_area_by_handle (hdl));
      ...
      gpi::pc::type::handle::descriptor_t
        manager_t::info (gspc::iml::AllocationHandle hdl) const
      {
        return get_area_by_handle(hdl)->descriptor(hdl);
      }

      std::unordered_map<std::string, double>
      manager_t::get_transfer_costs (std::list<gspc::iml::MemoryRegion> const& transfers) const
      {
      ...
      type::memcpy_id_t manager_t::memcpy
        ( gspc::iml::MemoryLocation const& dst
      ...
      void
      manager_t::remote_add_memory ( gspc::iml::SegmentHandle seg_id
      ...
      namespace
      {
          ...
          (gspc::iml::SegmentDescription const& description)
        {
          return gspc::util::visit<bool>
            ( description
            , [&] (gspc::iml::beegfs::SegmentDescription const&)
              {
                return true;
              }
            , [&] (gspc::iml::gaspi::SegmentDescription const&)
              {
                return false;
              }
            );
      ...
      void
      manager_t::remote_del_memory ( gspc::iml::SegmentHandle seg_id
                                   , global::topology_t& topology
                                   )
      {
