...
#include <stdexcept>
    ...
    namespace gpi::pc::memory
    {
      ...
      gspc::iml::AllocationHandle handle_generator_t::next_allocation()
      {
        return gspc::iml::AllocationHandle (bitpack (m_node_identifier, ++m_counter));
      }

      gspc::iml::SegmentHandle handle_generator_t::next_segment()
      {
        return gspc::iml::SegmentHandle (bitpack (m_node_identifier, ++m_counter));
      }
    }
