// Copyright (C) 2011-2012,2014-2017,2020-2026 Fraunhofer ITWM
...
#include <utility>
    ...
    namespace gpi::pc::memory
    {
      ...
      area_t::area_t (gspc::iml::MemorySize size)
        : _local_size (size)
        , m_mmgr (size, 1)
      {
      }
      ...
      {
        std::unordered_set<gspc::iml::AllocationHandle> result;
      ...
      bool area_t::is_local (gspc::iml::MemoryRegion region) const
      {
        return is_local (region, region.size);
      }

      bool
      area_t::is_local ( gspc::iml::MemoryLocation location
                       ...
                       ) const
      {
        ...
        const gspc::iml::MemoryOffset start = location.offset;
        const gspc::iml::MemoryOffset end   = start + amount;

        return is_range_local (hdl_it->second, start, end);
      }

      void
      area_t::check_bounds ( gspc::iml::MemoryLocation const& loc
      ...
      void
        area_t::remote_alloc ( gspc::iml::AllocationHandle hdl_id
      ...
      void
      area_t::alloc ( gspc::iml::MemorySize size
      ...
      void area_t::free (gspc::iml::AllocationHandle hdl)
      {
      ...
      void area_t::remote_free (gspc::iml::AllocationHandle hdl)
      {
        lock_type const lock (m_mutex);
      ...
      gpi::pc::type::handle::descriptor_t const&
        area_t::descriptor (gspc::iml::AllocationHandle hdl) const
      {
        lock_type lock (m_mutex);
      ...
      area_t::location_to_offset (gspc::iml::MemoryLocation loc)
      {
        lock_type lock (m_mutex);
      ...
      void *
      area_t::pointer_to (gspc::iml::MemoryLocation const& loc)
      {
        return raw_ptr (location_to_offset (loc));
      }

      gspc::iml::MemorySize
      area_t::read_from ( gspc::iml::MemoryLocation loc
                        , void *buffer
                        , gspc::iml::MemorySize amount
                        )
      {
        ...
        if (is_local (gspc::iml::MemoryRegion (loc, amount)))
        {
      ...
      gspc::iml::MemorySize
      area_t::write_to ( gspc::iml::MemoryLocation loc
                       , const void *buffer
                       , gspc::iml::MemorySize amount
                       )
      {
      ...
      gspc::iml::MemorySize
      area_t::read_from_impl ( gspc::iml::MemoryOffset offset
                             , void *buffer
                             , gspc::iml::MemorySize amount
                             )
      {
      ...
      gspc::iml::MemorySize
      area_t::write_to_impl ( gspc::iml::MemoryOffset offset
                            , const void *buffer
                            , gspc::iml::MemorySize amount
                            )
      {
