// Copyright (C) 2015-2016,2020-2023,2025-2026 Fraunhofer ITWM
...
#define FAIL_ON_NON_ZERO(F, Args...)             \
                                   ...
                                   )
      {
        ...
        for ( gaspi_rank_t r ((rank() + 1ul) % number_of_nodes())
            ; r != rank()
            ; r = (r + 1ul) % number_of_nodes()
            )
        {
