// Copyright (C) 2013,2015,2018-2021,2023,2025-2026 Fraunhofer ITWM
...
#include <gspc/util/unreachable.hpp>
      ...
      namespace gspc::util::parse::require
      {
        ...
        std::string identifier (position& pos)
        {
          ...
          while (!pos.end() && (gspc::util::isalpha (*pos) || *pos == '_' || gspc::util::isdigit (*pos)))
          {
            id.push_back (*pos); ++pos;
          }
