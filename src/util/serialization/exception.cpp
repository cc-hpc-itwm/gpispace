...
#include <gspc/util/cxx17/future_error.hpp>
...
#include <utility>
      ...
      namespace gspc::util::serialization::exception
      {
        namespace
        {
          ...
          struct builtin_exception_data
          {
            ...
            static std::optional<builtin_exception_data>
          ...
          struct user_defined_exception_data
          {
            ...
            static std::optional<user_defined_exception_data>
              from_exception_ptr ( std::exception_ptr
                                 , serialization_functions const&
                                 , std::optional<builtin_exception_data>
                                 );
          ...
          private:
            user_defined_exception_data
                ( std::string function
                , std::string blob
                , std::optional<builtin_exception_data> fallback
                )
            ...
            std::string _blob;
            std::optional<builtin_exception_data> _fallback;
...
#define WITH_CODE_AND_MAYBE_WHAT(type) WITH_CODE_AND_MAYBE_WHAT2 (type, type)
            ...
            case std_exception_types::future_error:
              {
                std::throw_with_nested
                  ( gspc::util::cxx17::make_future_error
...
#undef WITH_NOTHING
          ...
          std::optional<user_defined_exception_data>
              ...
              )
          {
            ...
            {
              std::optional<std::string> exception_data_v
            ...
            )
          {
            ...
            std::optional<builtin_exception_data> serialized_builtin
              (builtin_exception_data::from_exception_ptr (exception));

            std::optional<user_defined_exception_data> serialized_user_defined
              ( user_defined_exception_data::from_exception_ptr
