// Copyright (C) 2010,2012-2015,2018-2021,2023-2026 Fraunhofer ITWM
...
#include <vector>
  ...
  namespace gspc::com
  {
                                         ...
                                         )
    {
      ...
      {
        gspc_assert (bytes_transferred == sizeof (p2p::header_t));
    ...
    {
      std::shared_ptr<connection_t> that (shared_from_this());
      strand_.post
        ( [that, msg, hdl]
          {
