...
namespace fhg
{
  namespace pnete
  {
    namespace ui
    {
      ...
      void editor_window::show_log_monitor (int log)
      {
        dock_widget* widget
      ...
      void editor_window::show_execution_monitor (int exec)
      {
        dock_widget* widget
      ...
      namespace
      {
        ...
        float string_to_float (const QString& str)
        {
          const std::string stdstr (str.toStdString());
          fhg::util::parse::position_string pos (stdstr);
        ...
        QString doublespinbox_to_float (const QDoubleSpinBox* box)
        {
          ...
          (const std::string& type, const boost::optional<QString>& def)
        {
          ...
          else if (type == "float")
          {
            ...
            edit->setSuffix ("f");
            edit->setMinimum (std::numeric_limits<float>::lowest());
            edit->setMaximum (std::numeric_limits<float>::max());
      ...
      void editor_window::remote_job_finished
        (sdpa::client::Client* client, const QString& job_id_, xml::parse::id::ref::function* function)
      {
        _action_execute_current_file_remote_via_prompt->setEnabled (true);
