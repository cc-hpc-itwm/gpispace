    ...
    namespace client
    {
      ...
      void api_t::start ()
      {
        ...
        m_socket = open_socket (m_path);
          ...
          try
          {
            m_info = boost::get<gpi::pc::proto::control::info_reply_t>(boost::get<gpi::pc::proto::control::message_t>(communicate (gpi::pc::proto::control::message_t (gpi::pc::proto::control::info_t())))).info;
          }
          catch (...)
          {
            stop();
