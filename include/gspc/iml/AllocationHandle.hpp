...
namespace gspc::iml
{
  ...
  class GSPC_EXPORT AllocationHandle
  {
  public:
    ...
    GSPC_EXPORT friend bool operator<
      (AllocationHandle const&, AllocationHandle const&);
    friend GSPC_EXPORT std::hash<AllocationHandle>;
...
namespace std
{
  template<> struct hash<gspc::iml::AllocationHandle>
  {
    size_t operator() (gspc::iml::AllocationHandle const&) const;
  };
}

#include <gspc/iml/AllocationHandle.ipp>
