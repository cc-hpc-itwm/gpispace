// Copyright (C) 2014-2016,2020-2023,2025-2026 Fraunhofer ITWM
...
#include <vector>
  ...
  namespace gpi::api
  {
    ...
    {
    public:
      gaspi_t ( gspc::iml::vmem::gaspi_context&
    ...
    private:
      ...
      void *m_dma {nullptr};
      gspc::iml::vmem::gaspi_context::reserved_segment_id _segment_id;
      ...
      gspc::util::threadsafe_queue<notification_t> _write_ids;
      ...
      std::unordered_map<rank_t, gspc::util::threadsafe_queue<notification_id_t>>
        _ping_ids;
      ...
      gspc::util::finally_t<std::function<void()>> _interrupt_notification_check;
