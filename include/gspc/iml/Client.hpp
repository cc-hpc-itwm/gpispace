...
namespace gspc::iml
{
  ...
  class GSPC_EXPORT Client
  {
  public:
    //! Create a client connecting via a socket at \a socket_path.
    Client (std::filesystem::path const& socket_path);
    ...
    static void set_socket
      (::boost::program_options::variables_map&, std::filesystem::path);
    ...
    //! allocation.
    //! \see gspc::iml::SegmentAndAllocation
