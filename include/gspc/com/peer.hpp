// Copyright (C) 2010-2011,2014-2016,2018-2026 Fraunhofer ITWM
...
#include <unordered_map>
  ...
  namespace gspc::com
  {
    ...
    public:
      ...
      p2p::address_t const& address () const { return my_addr_.value(); }
      ...
      private:
        ...
        std::optional<p2p::address_t> _source;
        std::optional<message_t> _message;
      };
    ...
    private:
      ...
      std::optional<p2p::address_t> my_addr_;
