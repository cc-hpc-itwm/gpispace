...
#include <vector>
  ...
  namespace gspc::rpc
  {
    ...
    struct GSPC_EXPORT service_dispatcher
    {
    public:
      //! Construct a service dispatcher. The given serialization
      //! functions are used in case a registered handler
      service_dispatcher ( gspc::util::serialization::exception::serialization_functions
    ...
    private:
      ...
      gspc::util::serialization::exception::serialization_functions _serialization_functions;
    };
  }
