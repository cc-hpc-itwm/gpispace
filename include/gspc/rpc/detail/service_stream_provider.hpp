...
#include <gspc/rpc/detail/socket_traits.hpp>
...
#include <vector>
  ...
  namespace gspc::rpc
  {
    ...
    namespace detail
    {
      ...
      //!   exists as \c gspc::util::scoped_boost_asio_io_service_with_threads
      ...
      template<typename Protocol, typename Traits>
        struct GSPC_EXPORT service_stream_provider_with_deferred_start
      {
        static_assert
      ...
      public:
        ...
        //! gspc::util::connectable_to_address_string() can add be used.
      ...
      template<typename Protocol, typename Traits>
        struct GSPC_EXPORT service_stream_provider
      ...
      //! immediately.
      template<typename Protocol, typename Traits>
        struct GSPC_EXPORT service_stream_provider_with_deferred_dispatcher
