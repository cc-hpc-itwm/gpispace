// Copyright (C) 2013-2016,2018-2023,2026 Fraunhofer ITWM
...
namespace gspc::monitor
{
  namespace detail
  {
    struct formatted_log_event
    {
      ...
      gspc::logging::message _raw;

      formatted_log_event (gspc::logging::message);
    };
    ...
    public:
      ...
      int rowCount
        (QModelIndex const& = QModelIndex()) const override;
      int columnCount
        (QModelIndex const& = QModelIndex()) const override;
      ...
      std::vector<gspc::logging::message> data() const;
      void add (gspc::logging::message);
  ...
  public slots:
    ...
    void save();
    void append_log_event (gspc::logging::message const&);
