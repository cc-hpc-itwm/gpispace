// Copyright (C) 2010,2012,2014-2015,2020-2021,2023,2025-2026 Fraunhofer ITWM
...
namespace gspc::we::type {
  ...
  [[nodiscard]] auto to_string (ModuleCall const&) -> std::string;
}

#include <gspc/we/type/ModuleCall.ipp>
