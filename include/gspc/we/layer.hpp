// Copyright (C) 2010,2012-2016,2019-2026 Fraunhofer ITWM
...
namespace gspc::we
{
    ...
    {
    public:
      using id_type = gspc::scheduler::job_id_t;
      ...
      layer ( // submit: external activities from submitted net -> child jobs
            ...
            , std::function<void (std::string put_token_id, std::optional<std::exception_ptr>)> rts_token_put
    ...
    private:
      ...
      std::function<void (std::string, std::optional<std::exception_ptr>)> _rts_token_put;
      ...
      struct locked_parent_child_relation_type
      {
        ...
        std::optional<id_type> parent (id_type child);
      ...
      util::finally_t<std::function<void()>> _stop_extracting;
    };
}
