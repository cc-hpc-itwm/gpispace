// Copyright (C) 2010-2011,2013-2016,2019,2021-2023,2025-2026 Fraunhofer ITWM
...
namespace gspc::we::expr
{
  ...
  namespace parse
  {
    ...
    private:
      ...
      std::vector<shared_frame> _shared_frames;
