// Copyright (C) 2010-2015,2021,2023,2025-2026 Fraunhofer ITWM
...
#include <iosfwd>
  ...
  namespace gspc::we::expr::token
  {
    ...
    , _sin, _cos
    , _sqrt, _log
    , _toint, _tolong, _touint, _toulong, _tofloat, _todouble, _tobigint
    ...
    , _shared                 // shared value constructor (binary: place name, value)
