...
#include <vector>
      ...
      namespace gspc::util::boost::program_options
      {
        ...
        //! \see gspc::util::boost::program_options::validate()
        ...
        private:
          ...
          std::optional<std::string> _default_value_string;
        };
...
#include <gspc/util/boost/program_options/generic.ipp>
