// Copyright (C) 2014-2016,2019-2023,2025-2026 Fraunhofer ITWM
...
namespace gspc::logging { class stream_emitter; }
  ...
  namespace gspc::util
  {
    ...
    struct scoped_log_backtrace_and_exit_for_critical_errors
    {
      scoped_log_backtrace_and_exit_for_critical_errors
        (signal_handler_manager&, gspc::logging::stream_emitter&);
