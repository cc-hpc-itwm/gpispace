        ...
        namespace detail
        {
          ...
          template<typename Exception>
            struct serializer
              ...
              >
          {
            static std::optional<std::string> from_ptr (std::exception_ptr ex_ptr)
            {
              try
              {
          ...
          template<typename Exception>
            struct serializer
              < Exception
              , cxx17::void_t
                  < decltype (std::declval<std::optional<std::string>&>() = Exception::from_exception_ptr(std::declval<std::exception_ptr>()))
              ...
              >
          {
            static std::optional<std::string> from_ptr (std::exception_ptr ex)
            {
