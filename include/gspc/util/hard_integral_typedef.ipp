...
#define FHG_UTIL_HARD_INTEGRAL_TYPEDEF_IMPL(name_, base_)               \
    ...
    public:                                                             \
      ...
      template< typename U                                              \
              , typename                                                \
              = gspc::util::hit_detail::enable_if_cast_allowed<name_, U> \
      ...
      template<typename T, bool b>                                      \
        friend struct gspc::util::hit_detail::access;                    \
                                                                        \
      static_assert ( std::is_integral<base_>{}                         \
                    , "hard typedef base shall be integral"             \
                    );                                                  \
    };                                                                  \
    using gspc::util::hit_detail::to_string

    namespace gspc::util::hit_detail
    {
      template<typename T, typename = void>
        struct is_hit : std::false_type {};
      template<typename T>
        struct is_hit<T, gspc::util::cxx17::void_t<typename T::hard_typedef_tag>>
        : std::true_type {};
...
#define FHG_UTIL_HARD_INTEGRAL_TYPEDEF_ARITH_OPERATOR_IMPL(op_, lhs_, rhs_, result_) \
    ...
    {                                                                   \
      using gspc::util::hit_detail::value_of;                            \
    ...
    using gspc::util::hit_detail::force_semicolon_in_function_declaration_macro_hack
...
static_assert ( gspc::util::hit_detail::is_hit<hit_>{}                        \
...
{                                                               \
  ...
  {                                                             \
    gspc::util::hit_detail::enable_if_hit<name_, size_t>         \
