...
class DRTSImpl final : public gspc::scheduler::events::EventHandler
{
public:
  class Job
  {
...
public:
  ...
  DRTSImpl
    ...
    , gspc::iml::Client /*const*/* virtual_memory_socket
  ...
  void handle_worker_registration_response
    (gspc::com::p2p::address_t const& source, const gspc::scheduler::events::worker_registration_response *e) override;
  void handleSubmitJobEvent
    (gspc::com::p2p::address_t const& source, const gspc::scheduler::events::SubmitJobEvent *e) override;
  void handleCancelJobEvent
    (gspc::com::p2p::address_t const& source, const gspc::scheduler::events::CancelJobEvent *e) override;
  void handleJobFailedAckEvent
    (gspc::com::p2p::address_t const& source, const gspc::scheduler::events::JobFailedAckEvent *e) override;
  void handleJobFinishedAckEvent
    (gspc::com::p2p::address_t const& source, const gspc::scheduler::events::JobFinishedAckEvent *e) override;
...
private:
  ...
  gspc::we::loader::loader m_loader;

  gspc::logging::stream_emitter& _log_emitter;
  void emit_gantt (wfe_task_t const&, gspc::scheduler::daemon::NotificationEvent::state_t);

  gspc::iml::Client /*const*/* _virtual_memory_api;
  gspc::iml::SharedMemoryAllocation /*const*/* _shared_memory;

  gspc::util::interruptible_threadsafe_queue<gspc::scheduler::events::SchedulerEvent::Ptr
                                           > m_event_queue;
  ...
  gspc::util::interruptible_threadsafe_queue<std::shared_ptr<DRTSImpl::Job>>
    m_pending_jobs;

  gspc::com::channel _peer;
