// Copyright (C) 2015-2017,2021-2023,2025-2026 Fraunhofer ITWM
...
#include <gspc/drts/scoped_rifd.fwd.hpp>
...
namespace gspc
{
  namespace options
  {
    ...
    GSPC_EXPORT ::boost::program_options::options_description scoped_rifd
      (int = rifd::nodefile | rifd::rif_strategy | rifd::rif_port);
  }

  namespace rifd
  {
    struct GSPC_EXPORT strategy
    {
  ...
  class GSPC_EXPORT scoped_rifd : public rifds
  {
  public:
  ...
  class GSPC_EXPORT scoped_rifds : public rifds
  {
  public:
    using rifds::rifds;
