  ...
  namespace gspc::scheduler::daemon
  {
    ...
    struct JobFSM_ : public ::boost::msm::front::state_machine_def<JobFSM_>
    {
      ...
      struct s_finished : public ::boost::msm::front::state<>
      {
        ...
        s_finished() = default;
        s_finished (gspc::we::type::Activity result_)
      ...
      static status::code state_code (size_t state)
      {
        ...
        gspc_assert ( state < sizeof (state_codes) / sizeof (*state_codes)
    ...
    {
      std::map<gspc::scheduler::worker_id_t, terminal_state> individual_results;
    ...
    public:
      ...
      std::optional<gspc::scheduler::Type> const& scheduler_type() const;
      ...
      void JobFinished (gspc::we::type::Activity);
      void Reschedule();
    ...
    private:
      ...
      gspc::we::type::Requirements_and_preferences _requirements_and_preferences;
      std::optional<gspc::scheduler::Type> _scheduler_type;
