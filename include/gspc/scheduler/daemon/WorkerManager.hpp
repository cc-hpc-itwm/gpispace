// Copyright (C) 2010-2011,2014-2017,2019-2026 Fraunhofer ITWM
  ...
  namespace gspc::scheduler::daemon
  {
    ...
    public:
      ...
      std::unordered_set<worker_id_t> find_subm_or_ack_workers
        (gspc::scheduler::job_id_t const&, std::set<worker_id_t> const&) const;
      ...
      using worker_connections_t
        = ::boost::bimap < ::boost::bimaps::unordered_set_of<std::string>
                       , ::boost::bimaps::unordered_set_of<gspc::com::p2p::address_t>
                       >;

      std::optional<WorkerManager::worker_connections_t::right_iterator>
        worker_by_address (gspc::com::p2p::address_t const&);
      ...
      std::optional<job_id_t> get_next_worker_pending_job_to_submit (worker_id_t const&);
