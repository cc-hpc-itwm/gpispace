...
#define SAVE_SCHEDULEREVENT_CONSTRUCT_DATA(EVENT_VARIABLE) \
  (void) _archive;                                    \
  (void) EVENT_VARIABLE
#define LOAD_SCHEDULEREVENT_CONSTRUCT_DATA()         \
  (void) _archive


#define SAVE_JOBEVENT_CONSTRUCT_DATA(EVENT_VARIABLE)    \
  SAVE_SCHEDULEREVENT_CONSTRUCT_DATA (EVENT_VARIABLE);       \
...
#define LOAD_JOBEVENT_CONSTRUCT_DATA(JOB_ID_VAR_NAME)                \
  ...
  LOAD_FROM_ARCHIVE (gspc::scheduler::job_id_t, JOB_ID_VAR_NAME)
