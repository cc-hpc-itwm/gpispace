// Copyright (C) 2015-2016,2020-2026 Fraunhofer ITWM
...
#include <variant>
  ...
  namespace gspc::scheduler::events
  {
    ...
    {
    public:
      using value_t = gspc::pnet::type::value::value_type;
      ...
      using serialized = std::variant< gspc::pnet::type::value::value_type
                                     , std::string
                                     >;
      ...
      SAVE_TO_ARCHIVE_WITH_TEMPORARY
        ...
        , gspc::util::visit
          ...
          , [] ( std::exception_ptr const& ex
            ...
            {
              return gspc::util::serialization::exception::serialize (ex);
            }
          )
        )
    }
      ...
      ::new (e) workflow_response_response
          ...
          , gspc::util::visit
            ...
            , [] ( std::string const& ex
              ...
              {
                return gspc::util::serialization::exception::deserialize (ex);
              }
            )
          );
    }
