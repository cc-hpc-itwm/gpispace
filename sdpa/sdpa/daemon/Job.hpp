  ...
  namespace daemon {
    ...
    struct JobFSM_ : public boost::msm::front::state_machine_def<JobFSM_>
    {
      ...
      struct transition_table : boost::mpl::vector
        ...
        //      +---------------+---------------------------------------+-------------------+---------------------+-----
        _row<   Canceling, 	events::CancelJobAckEvent,     	Canceled>,
        a_row<  Canceling, 	events::JobFinishedEvent,      	Canceled,       &sm::action_job_finished>,
        a_row<  Canceling, 	events::JobFailedEvent,           Canceled,       &sm::action_job_failed>,
        _irow<  Canceling,      events::CancelJobEvent>,
        //      +---------------+-------------------------------------------+-------------------+---------------------+-----
