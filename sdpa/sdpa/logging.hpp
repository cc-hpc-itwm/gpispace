...
#define SDPA_LDECLARE_LOGGER(logger)           mutable ::fhg::log::LoggerApi logger
#define SDPA_LDEFINE_LOGGER(logger, name) ::fhg::log::LoggerApi logger(::fhg::log::getLogger(name))
