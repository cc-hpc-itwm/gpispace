...
{
  _scheduler.worker_manager().addWorker ("worker_0", 1, {}, false, fhg::util::random_string(), fhg::util::random_string());
  _scheduler.worker_manager().addWorker ("worker_1", 1, {}, false, fhg::util::random_string(), fhg::util::random_string());
...
{
  _scheduler.worker_manager().addWorker ("worker_0", 1, {sdpa::capability_t ("C", "worker_0")}, false, fhg::util::random_string(), fhg::util::random_string());
  _scheduler.worker_manager().addWorker ("worker_1", 1, {}, false, fhg::util::random_string(), fhg::util::random_string());
...
{
  _scheduler.worker_manager().addWorker ("A0", 1, {sdpa::capability_t ("A", "A0")}, false, fhg::util::random_string(), fhg::util::random_string());
  _scheduler.worker_manager().addWorker ("B0", 1, {sdpa::capability_t ("B", "B0")}, false, fhg::util::random_string(), fhg::util::random_string());
  _scheduler.worker_manager().addWorker ("A1", 1, {sdpa::capability_t ("A", "A1")}, false, fhg::util::random_string(), fhg::util::random_string());
  _scheduler.worker_manager().addWorker ("B1", 1, {sdpa::capability_t ("B", "B1")}, false, fhg::util::random_string(), fhg::util::random_string());
...
{
  _scheduler.worker_manager().addWorker ("worker", 1, {}, false, fhg::util::random_string(), fhg::util::random_string());
  ...
  (multiple_job_submissions_no_requirements, fixture_scheduler_and_requirements)
{
  ...
  _scheduler.worker_manager().addWorker (worker_id, boost::none, {}, true, fhg::util::random_string(), fhg::util::random_string());
                        ...
                        )
{
  ...
  _scheduler.worker_manager().addWorker (worker_id, boost::none, {}, false, fhg::util::random_string(), fhg::util::random_string());
...
struct fixture_minimal_cost_assignment
{
  ...
  {
    _scheduler.worker_manager().addWorker ("worker_01", 1, {}, false, "node1", fhg::util::random_string());
    _scheduler.worker_manager().addWorker ("worker_02", 1, {}, false, "node1", fhg::util::random_string());
    _scheduler.worker_manager().addWorker ("worker_03", 1, {}, false, "node1", fhg::util::random_string());
    _scheduler.worker_manager().addWorker ("worker_04", 1, {}, false, "node1", fhg::util::random_string());
    _scheduler.worker_manager().addWorker ("worker_05", 1, {}, false, "node2", fhg::util::random_string());
    _scheduler.worker_manager().addWorker ("worker_06", 1, {}, false, "node2", fhg::util::random_string());
    _scheduler.worker_manager().addWorker ("worker_07", 1, {}, false, "node2", fhg::util::random_string());
    _scheduler.worker_manager().addWorker ("worker_08", 1, {}, false, "node2", fhg::util::random_string());
    _scheduler.worker_manager().addWorker ("worker_09", 1, {}, false, "node3", fhg::util::random_string());
    _scheduler.worker_manager().addWorker ("worker_10", 1, {}, false, "node3", fhg::util::random_string());
    _scheduler.worker_manager().addWorker ("worker_11", 1, {}, false, "node3", fhg::util::random_string());
    _scheduler.worker_manager().addWorker ("worker_12", 1, {}, false, "node3", fhg::util::random_string());
    _scheduler.worker_manager().addWorker ("worker_13", 1, {}, false, "node4", fhg::util::random_string());
    _scheduler.worker_manager().addWorker ("worker_14", 1, {}, false, "node4", fhg::util::random_string());
    _scheduler.worker_manager().addWorker ("worker_15", 1, {}, false, "node4", fhg::util::random_string());
    _scheduler.worker_manager().addWorker ("worker_16", 1, {}, false, "node4", fhg::util::random_string());
    _scheduler.worker_manager().addWorker ("worker_17", 1, {}, false, "node5", fhg::util::random_string());
    _scheduler.worker_manager().addWorker ("worker_18", 1, {}, false, "node5", fhg::util::random_string());
    _scheduler.worker_manager().addWorker ("worker_19", 1, {}, false, "node5", fhg::util::random_string());
    _scheduler.worker_manager().addWorker ("worker_20", 1, {}, false, "node5", fhg::util::random_string());
  }
                        ...
                        )
{
  ...
  {
    _scheduler.worker_manager().addWorker (worker_id, 1, {}, false, worker_id, fhg::util::random_string());
  }
...
BOOST_AUTO_TEST_CASE (scheduling_bunch_of_jobs_with_preassignment_and_load_balancing)
{
  ...
  {
    _scheduler.worker_manager().addWorker (worker_ids[i], 1, {}, false, host_ids[i], fhg::util::random_string());
  }
...
BOOST_AUTO_TEST_CASE (scheduling_bunch_of_jobs_with_re_assignment_when_new_matching_worker_appears)
{
  ...
  sdpa::daemon::CoallocationScheduler
   ...
   _scheduler.worker_manager().addWorker ("worker_0", 1, {}, false, "host_0", fhg::util::random_string());
   ...
   _scheduler.worker_manager().addWorker ("worker_1", 1, {}, false, "host_1", fhg::util::random_string());
