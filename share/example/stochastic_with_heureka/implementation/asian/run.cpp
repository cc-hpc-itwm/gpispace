...
namespace
{
  namespace option
  {
    ...
    constexpr char const* const controle_variate {"controle-variate"};
  }
  ...
  boost::program_options::options_description options()
  {
    ...
    description.add_options()
      ...
      , "Optionsart: FloC, FloP, FixC, FixP"
      )
      ( option::controle_variate
      , boost::program_options::value<bool>()->required()
      , "use controle variate"
      );

    return description;
  }

  asian::AsianTyp read_option_type (std::string const& o)
  {
    return ( o == "FloC" ? asian::FloC
           : o == "FloP" ? asian::FloP
           : o == "FixC" ? asian::FixC
           : o == "FixP" ? asian::FixP
          ...
          try
          {
            return we::type::bytearray
              ( asian::param_t
                ...
                , vm[option::controle_variate].as<bool>()
                )
              );
          }
