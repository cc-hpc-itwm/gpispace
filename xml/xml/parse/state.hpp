    ...
    namespace state
    {
      ...
      public:
        type (void)
          ...
          , _Wshadow_struct (false)
          , _Wshadow_function (false)
          , _Wdefault_construction (false)
          , _Wunused_field (false)
          , _Wport_not_connected (false)
          , _Wunexpected_element (false)
          , _Woverwrite_function_name_trans (false)
          , _Woverwrite_function_internal_trans (false)
          , _Wproperty_overwritten (false)
          , _Wtype_map_duplicate (false)
          , _Wtype_get_duplicate (false)
          , _Woverwrite_context (false)
          , _Windependent_place (false)
          , _Windependent_transition (false)
          , _Wconflicting_port_types (false)
          , _Woverwrite_file (false)
          , _Wbackup_file (false)
          , _Wduplicate_external_function (false)
          , _Wproperty_unknown (false)
          , _Winline_many_output_ports (false)
          , _Wvirtual_place_not_tunneled (false)
