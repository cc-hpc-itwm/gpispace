        ...
        ClientState* ClientContext::_States[] = 
{
        ...
        void ClientState::Start(ClientContext& context, const std::string & cfg)
        {
            Default(context);
            return;
        }
        ...
        void ClientFsm_Unconfigured::Start(ClientContext& context, const std::string & cfg)
        {
        ...
        void ClientFsm_Configured::Cancel(ClientContext& context, const seda::IEvent::Ptr & evt)
        {
            ...
            ClientState& endState = context.getState();
