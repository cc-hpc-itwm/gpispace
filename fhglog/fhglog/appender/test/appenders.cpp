...
BOOST_AUTO_TEST_CASE (stream_appender)
{
  ...
  logger.addAppender (fhg::log::Appender::ptr_t (new fhg::log::StreamAppender (logstream, "%m")));
...
BOOST_AUTO_TEST_CASE (two_stream_appenders)
{
  ...
  logger.addAppender (fhg::log::Appender::ptr_t (new fhg::log::StreamAppender (logstream_0, "%m")));
  logger.addAppender (fhg::log::Appender::ptr_t (new fhg::log::StreamAppender (logstream_1, "%m")));
