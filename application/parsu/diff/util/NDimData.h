			    ...
			    
{
	...
	MetaInfoClass getMetaInfo(const NDimData<NDIM,DataType,MetaInfoClass> &);
...
template <short NDIM, typename DataType, typename MetaInfoClass>
  inline MetaInfoClass 
    NDimData<NDIM,DataType,MetaInfoClass>::getMetaInfo(const NDimData<NDIM,DataType,MetaInfoClass> & Obj)
{
  return Obj.mMetaInfo;
}
