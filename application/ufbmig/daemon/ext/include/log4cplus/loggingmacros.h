...
#define _LOG4CPLUS_PRINTF_BUF_SIZE (4*1024)

#define LOG4CPLUS_PRINTF_BODY(logger, logLevel, ...)                    \
    do {                                                                \
        if((logger).isEnabledFor(log4cplus::logLevel##_LOG_LEVEL)) {    \
            char _log4cplus_printf_buf[_LOG4CPLUS_PRINTF_BUF_SIZE];     \
            snprintf(_log4cplus_printf_buf, _LOG4CPLUS_PRINTF_BUF_SIZE, __VA_ARGS__);\
            (logger).forcedLog(log4cplus::logLevel##_LOG_LEVEL,         \
                _log4cplus_printf_buf, __FILE__, __LINE__);             \
        }                                                               \
    } while (0)
...
#define LOG4CPLUS_TRACE_PRINTF(logger, ... )                            \
    LOG4CPLUS_PRINTF_BODY (logger, TRACE, __VA_ARGS__)
#else
...
#define LOG4CPLUS_TRACE_PRINTF(logger, ... ) do { } while (0)
#endif
...
#define LOG4CPLUS_DEBUG_PRINTF(logger, ... )                            \
    LOG4CPLUS_PRINTF_BODY (logger, DEBUG, __VA_ARGS__)
#else
#define LOG4CPLUS_DEBUG(logger, logEvent) do { } while (0)
#define LOG4CPLUS_DEBUG_STR(logger, logEvent) do { } while (0)
#define LOG4CPLUS_DEBUG_PRINTF(logger, ... ) do { } while (0)
#endif
...
#define LOG4CPLUS_INFO_PRINTF(logger, ... )                             \
    LOG4CPLUS_PRINTF_BODY (logger, INFO, __VA_ARGS__)
#else
#define LOG4CPLUS_INFO(logger, logEvent) do { } while (0)
#define LOG4CPLUS_INFO_STR(logger, logEvent) do { } while (0)
#define LOG4CPLUS_INFO_PRINTF(logger, ... ) do { } while (0)
#endif
...
#define LOG4CPLUS_WARN_PRINTF(logger, ... )                             \
    LOG4CPLUS_PRINTF_BODY (logger, WARN, __VA_ARGS__)
#else
#define LOG4CPLUS_WARN(logger, logEvent) do { } while (0)
#define LOG4CPLUS_WARN_STR(logger, logEvent) do { } while (0)
#define LOG4CPLUS_WARN_PRINTF(logger, ... ) do { } while (0)
#endif
...
#define LOG4CPLUS_ERROR_PRINTF(logger, ... )                            \
    LOG4CPLUS_PRINTF_BODY (logger, ERROR, __VA_ARGS__)
#else
#define LOG4CPLUS_ERROR(logger, logEvent) do { } while (0)
#define LOG4CPLUS_ERROR_STR(logger, logEvent) do { } while (0)
#define LOG4CPLUS_ERROR_PRINTF(logger, ... ) do { } while (0)
#endif
...
#define LOG4CPLUS_FATAL_PRINTF(logger, ... )                            \
    LOG4CPLUS_PRINTF_BODY (logger, FATAL, __VA_ARGS__)
#else
#define LOG4CPLUS_FATAL(logger, logEvent) do { } while (0)
#define LOG4CPLUS_FATAL_STR(logger, logEvent) do { } while (0)
#define LOG4CPLUS_FATAL_PRINTF(logger, ... ) do { } while (0)
#endif
