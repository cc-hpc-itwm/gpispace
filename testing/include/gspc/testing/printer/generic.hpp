...
#define GSPC_BOOST_TEST_TEMPLATED_LOG_VALUE_PRINTER(TMPL, SPEC_PARAM, OS_NAME, VAL_NAME) \
  namespace boost                                                       \
  {                                                                     \
...
#define GSPC_BOOST_TEST_LOG_VALUE_PRINTER(SPEC_PARAM, OS_NAME, VAL_NAME) \
  namespace boost                                                       \
  {                                                                     \
    namespace test_tools                                                \
    {                                                                   \
...
#define GSPC_BOOST_TEST_LOG_VALUE_PRINTER_WRAPPED(SPEC_PARAM, WRAPPER)   \
  GSPC_BOOST_TEST_LOG_VALUE_PRINTER (SPEC_PARAM, os, val)                \
  {                                                                     \
    os << WRAPPER (val);                                                \
  }

#define GSPC_BOOST_TEST_PRINT_LOG_VALUE_HELPER(...)            \
