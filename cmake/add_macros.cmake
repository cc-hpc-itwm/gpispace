...
#! `GSPC_EXPORT`, CMake's `GenerateExportHeader`
#! module or alike).
...
#! installed to `${CMAKE_INSTALL_LIBDIR}/`, but \a INSTALL_DESTINATION can overwrite
...
#! unless the global variable \c GSPC_INSTALL_DO_NOT_BUNDLE is set to
...
#! added with \a RPATH or via the \c GSPC_INSTALL_RPATH_DIRS global. To
...
function (extended_add_library)
  ...
  _default_if_unset (ARG_INSTALL_DESTINATION "${CMAKE_INSTALL_LIBDIR}")
...
#! variable \c GSPC_INSTALL_DO_NOT_BUNDLE is set to true. Also see the
