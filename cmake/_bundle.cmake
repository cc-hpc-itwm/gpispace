...
# default is GSPC_INSTALL_DO_NOT_BUNDLE = OFF, i.e. bundling, for
...
# GPI-Space. This can be done globally via the GSPC_INSTALL_RPATH_DIRS list
...
#   GSPC_INSTALL_DO_NOT_BUNDLE in *their* CMakelists, so setting it is
...
set (GSPC_INSTALL_DO_NOT_BUNDLE OFF CACHE BOOL "Do not bundle installed targets")
set (GSPC_INSTALL_RPATH_DIRS "" CACHE STRING
...
before calling `include (add_macros)`.
Enabled at-include=${_add_macros_first_enabled_languages} vs now=${_languages}."
  ...
  foreach (_language ${_languages})
    ...
    #  == if (${_orig_CMAKE_${_language}_USE_IMPLICIT_LINK_DIRECTORIES_IN_RUNTIME_PATH} XOR ${GSPC_INSTALL_DO_NOT_BUNDLE})
    if ((${_orig_CMAKE_${_language}_USE_IMPLICIT_LINK_DIRECTORIES_IN_RUNTIME_PATH} AND NOT ${GSPC_INSTALL_DO_NOT_BUNDLE})
        OR (NOT ${_orig_CMAKE_${_language}_USE_IMPLICIT_LINK_DIRECTORIES_IN_RUNTIME_PATH} AND ${GSPC_INSTALL_DO_NOT_BUNDLE}))
...
but GSPC_INSTALL_DO_NOT_BUNDLE=${GSPC_INSTALL_DO_NOT_BUNDLE} would like to overwrite that, which it \
...
thus not supported in this environment."
        ...
        set (CMAKE_${_language}_USE_IMPLICIT_LINK_DIRECTORIES_IN_RUNTIME_PATH
          ${GSPC_INSTALL_DO_NOT_BUNDLE}
          CACHE BOOL
          "Whether CMake should add CMAKE_${_language}_IMPLICIT_LINK_DIRECTORIES
           to a target's RPATH. Needs to be in sync with GSPC_INSTALL_DO_NOT_BUNDLE!"
          FORCE
        )
...
function (_maybe_bundle_target_and_rpath TARGET_NAME INSTALL_DESTINATION RPATH CREATE_INFO)
  ...
  if (NOT ${GSPC_INSTALL_DO_NOT_BUNDLE})
  ...
  foreach (_rpath IN LISTS GSPC_INSTALL_RPATH_DIRS _maybe_install_bundle_lib_dir)
  ...
  set_property (TARGET ${TARGET_NAME} PROPERTY INSTALL_RPATH_USE_LINK_PATH ${GSPC_INSTALL_DO_NOT_BUNDLE})
endfunction()
