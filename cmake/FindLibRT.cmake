# Copyright (C) 2011-2013,2016,2021,2023 Fraunhofer ITWM
...
if (LIBRT_INCLUDE_DIR AND LIBRT_LIBRARY)
  ...
  if (NOT LibRT_FIND_QUIETLY)
    message (STATUS "Found librt headers in ${LIBRT_INCLUDE_DIR} and libraries ${LIBRT_STATIC_LIBRARY} ${LIBRT_SHARED_LIBRARY}")
  endif ()
else ()
