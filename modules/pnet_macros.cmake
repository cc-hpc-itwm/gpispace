...
macro(PNET_COMPILE)
  ...
  if (PNET_BUILD)
    ...
    elseif ("${CMAKE_GENERATOR}" STREQUAL "Ninja")
      # note that we require a plain 'make' in $PATH for ninja.
      set (_make_cmd "make")
    else()
    ...
    add_custom_target(pnet-${PNET_NAME}-build
      "${_make_cmd}" -C ${PNET_GENERATE} "BOOST_ROOT=${BOOST_ROOT}" "SDPA_INCLUDE=${CMAKE_SOURCE_DIR}/src/" "SDPA_LDPATH=${CMAKE_BINARY_DIR}/src/we"
      COMMENT "Building modules for petri-net ${PNET_NAME}"
      DEPENDS pnet-${PNET_NAME}-gen we-dev
      WORKING_DIRECTORY ${CMAKE_CURRENT_BINARY_DIR}
      )
