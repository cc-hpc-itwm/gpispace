...
macro(FHG_ADD_PLUGIN)
  PARSE_ARGUMENTS(PLUGIN
    "EXPORTS;LINK_LIBRARIES;HEADERS;COMPONENT;DEPENDS"
  ...
  if(PLUGIN_INSTALL)
    install(TARGETS ${PLUGIN_NAME}-plugin LIBRARY DESTINATION ${PLUGIN_DESTINATION_DIR} COMPONENT ${PLUGIN_COMPONENT})
    if (PLUGIN_HEADERS)
      install(FILES ${PLUGIN_HEADERS} DESTINATION ${HEADER_DESTINATION_DIR} COMPONENT ${PLUGIN_COMPONENT})
    endif()
  endif()
  ...
  if (PLUGIN_BUILTIN OR BUILTIN_${upper_name}_PLUGIN)
    ...
    if (PLUGIN_INSTALL)
      install(TARGETS ${PLUGIN_NAME}-plugin.static ARCHIVE DESTINATION ${PLUGIN_DESTINATION_DIR} COMPONENT ${PLUGIN_COMPONENT})
    endif()
  endif()
endmacro()
