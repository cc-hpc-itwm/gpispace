...
int main(int argc, char *argv[])
{
  ...
  try
    {
      loader->load("testDynamicArrayClean-mod", "/u/herc/machado/current_work/sdpa/fvm_pc_separated/tests/testDynamicArrayClean-mod.so");
    }
  catch (sdpa::modules::ModuleLoadFailed &mlf)
    {
  ...
  sdpa::modules::Module  &mod1 = loader->get("testDynamicArrayClean-mod");
  ...
  try 
    {
      mod1.call("test_dynamicArrayClean", params1);
    }
  catch (const std::exception & ex) {
