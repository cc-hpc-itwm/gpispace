...
//	namespace tag {
//	  struct connection_pt {};
//	  struct connection_tp {};
//	}
//
//	template <tag::connection_pt, typename Net, typename Edge> void add_edge(Net & n, Edge & e, Net::tid_t & tid, Net::pid_t & pid)
//	{
//	  using namespace petri_net;
//	  n.add_edge(e, connection_t(PT, tid, pid));
//	}
  }
}}
