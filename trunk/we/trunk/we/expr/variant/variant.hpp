...
#ifndef _WE_EXPR_VARIANT_VARIANT_HPP
#define _WE_EXPR_VARIANT_VARIANT_HPP
...
namespace boost
{
  static inline std::size_t hash_value (const expr::variant::type & v)
  {
    static const expr::variant::visitor_hash h;
