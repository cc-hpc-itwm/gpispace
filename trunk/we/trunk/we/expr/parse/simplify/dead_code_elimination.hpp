...
#ifndef _EXPR_PARSE_SIMPLIFY_DEAD_CODE_ELIMINATION_HPP
#define _EXPR_PARSE_SIMPLIFY_DEAD_CODE_ELIMINATION_HPP 1
...
namespace expr
{
  namespace parse
  {
    namespace simplify
    {
      namespace detail
      {
        class dead_code_elimination : public boost::static_visitor<node::type>
        {
        private:
        ...
        public:
          dead_code_elimination (key_set_type & referenced_names)
      ...
      inline void
      dead_code_elimination ( expression_list & list
                            ...
                            )
      {
        ...
        while (it != list.rend())
        {
          detail::dead_code_elimination visitor (referenced_names);
