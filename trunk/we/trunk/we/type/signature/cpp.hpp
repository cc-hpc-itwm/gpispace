...
namespace signature
{
  namespace cpp
  {
    ...
    namespace visitor
    {
      ...
      public:
        cpp_includes (std::ostream & _os, seen_type & _seen)
          : os (_os), seen (_seen)
        {}
        ...
        void operator () (const structured_t & map) const
        {
          for ( structured_t::const_iterator field (map.begin())
            ...
            {
              boost::apply_visitor (cpp_includes (os, seen), field->second);
            }
        }
      };
    }
                           ...
                           )
    {
      ...
      boost::apply_visitor (visitor::cpp_includes (os, seen), s.desc());
    ...
    {
      cpp_header (os, s, s.nice(), boost::filesystem::path ("<unknown>"));
    }
  }
}
