...
macro(KDE_CTEST_SETUP)
   ...
   if(NOT DEFINED CTEST_CMAKE_GENERATOR)
      ...
      if(CMAKE_HOST_WIN32)
         ...
         # otherwise mingw.
         find_program(_KDECTEST_CL_EXE cl)
         if(_KDECTEST_CL_EXE)
   ...
   if("${CTEST_CMAKE_GENERATOR}" MATCHES Makefile)
      find_program(MAKE_EXECUTABLE gmake make)
   ...
   if ("${_ctest_vcs}" STREQUAL svn)
      string(RANDOM LENGTH 10 _tmpDir)
      set(_tmpDir "${KDE_CTEST_DASHBOARD_DIR}/tmp/${_tmpDir}")
      message("_tmpDir is ${_tmpDir}")
      file(MAKE_DIRECTORY "${_tmpDir}")
      execute_process(COMMAND ${SVN_EXECUTABLE} export ${KDE_CTEST_VCS_REPOSITORY}/main/trunk/CTestConfig.cmake
