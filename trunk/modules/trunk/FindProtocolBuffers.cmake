...
IF( NOT ${PB_HOME} STREQUAL "" )
    ...
    SET(_pb_BINARY_SEARCH_DIRS ${PB_HOME}/bin ${_pb_BINARY_SEARCH_DIRS})
...
IF( NOT $ENV{PB_BINARYDIR} STREQUAL "" )
  SET(_pb_BINARY_SEARCH_DIRS $ENV{PB_BINARYDIR} ${_pb_BINARY_SEARCH_DIRS})
ENDIF( NOT $ENV{PB_BINARYDIR} STREQUAL "" )

IF( PB_HOME )
  SET(_pb_INCLUDE_SEARCH_DIRS ${PB_HOME}/include ${_pb_INCLUDE_SEARCH_DIRS})
  SET(_pb_LIBRARIES_SEARCH_DIRS ${PB_HOME}/lib ${_pb_LIBRARIES_SEARCH_DIRS})
  SET(_pb_BINARY_SEARCH_DIRS ${PB_HOME}/lib ${_pb_BINARY_SEARCH_DIRS})
  SET(_pb_HOME ${PB_HOME})
ENDIF( PB_HOME )
...
FIND_LIBRARY(PB_LIBRARY
  ...
  HINTS ${_pb_LIBRARIES_SEARCH_DIRS}
  )
