...
#  message(STATUS "Looking for binary  in '${_xxx_BINARY_SEARCH_DIRS}'")
  ...
  ENDIF(WIN32)
  message("  search for library '${${_NAME_UPPER}_LIBRARY_NAMES}'")
  ...
  message("  ${_NAME_UPPER} 2: '-I${${_NAME_UPPER}_INCLUDE_DIR}' '-L${${_NAME_UPPER}_LIBRARY_DIR}' ")
  message("             '${${_NAME_UPPER}_LIBRARIES}' '${${_NAME_UPPER}_LIBRARY}'")
