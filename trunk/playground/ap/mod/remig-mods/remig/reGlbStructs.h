...
typedef struct {
	...
	char prefix_path[max_path_len]; // initialized in cfg.cpp
	char config_file[max_path_len]; // initialized in cfg.cpp
	char data_file[max_path_len];     // initialized in reApplInit.cpp
	char velocity_file[max_path_len]; //  ""
