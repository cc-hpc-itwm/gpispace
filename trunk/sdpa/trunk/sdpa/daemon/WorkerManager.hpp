...
namespace sdpa { namespace daemon {
  ...
  public:
      ...
      void addWorker( const Worker::worker_id_t& workerId, unsigned int rank, unsigned int cap, const sdpa::worker_id_t& agent_uuid = "" ) throw (WorkerAlreadyExistException);
