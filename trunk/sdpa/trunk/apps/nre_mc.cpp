...
#include <sdpa/daemon/nre/MCWorkerClient.hpp>
...
int main (int argc, char **argv)
{
  ...
  try {
	 ...
	 // Remember, just for test!
	sdpa::daemon::NRE<sdpa::nre::worker::MCWorkerClient>::ptr_t ptrNRE
		  	  = sdpa::daemon::NREFactory<EmptyWorkflowEngine, sdpa::nre::worker::MCWorkerClient >::create( nreName
		 	 																	, nreUrl
		 	 																	, aggName
		 	 																	, workerUrl
		 	 																	, guiUrl
