...
void C2D2D2DDummyGwesTest::testDaemonFSM_JobFinished()
{
	...
	//sdpa::client::ClientApi::ptr_t api(sdpa::client::ClientApi::create("empty config", sdpa::daemon::USER, sdpa::daemon::ORCHESTRATOR));
...
void C2D2D2DDummyGwesTest::testDaemonFSM_JobCancelled_from_Pending()
{
	ostringstream os;
