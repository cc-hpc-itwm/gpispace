...
CPPUNIT_TEST_SUITE_REGISTRATION( D2D2DRealGwesTest );

D2D2DRealGwesTest::D2D2DRealGwesTest() :
	SDPA_INIT_LOGGER("sdpa.tests.D2D2DRealGwesTest")
{
}
...
string D2D2DRealGwesTest::read_workflow(string strFileName)
{
...
void D2D2DRealGwesTest::setUp() { //initialize and start the finite state machine
...
void D2D2DRealGwesTest::tearDown()
{
...
void D2D2DRealGwesTest::testDaemonFSM_JobFinished()
{
	ostringstream os;
...
void D2D2DRealGwesTest::testDaemonFSM_JobFailed()
{
	ostringstream os;
...
void D2D2DRealGwesTest::testDaemonFSM_JobCancelled()
{
	ostringstream os;
...
void D2D2DRealGwesTest::testDaemonFSM_JobCancelled_from_Pending()
{
	ostringstream os;
