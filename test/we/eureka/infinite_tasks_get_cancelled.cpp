...
#include <test/we/eureka/Fixture.hpp>
...
BOOST_FIXTURE_TEST_CASE
  ( we_eureka_infinite_tasks_are_cancelled
  ...
  )
{
  ...
  for (unsigned int t (0); t < number_of_tasks; ++t)
  {
    ...
    WE_TEST_EUREKA_PUT_TOKEN ("loop", gspc::we::type::literal::control());
  }
  ...
  jobserver.wait (number_of_tasks, expected_tasks, JobServer::Cancelled{});
