...
#include <test/we/eureka/jobserver/client.hpp>
...
#include <gspc/util/scoped_boost_asio_io_service_with_threads.hpp>
        ...
        namespace gspc::we::test::eureka::jobserver
        {
          ...
          private:
            ...
            gspc::rpc::sync_remote_function<protocol::cancelled> _cancelled;
            gspc::rpc::sync_remote_function<protocol::exited_or_cancelled>
              _exited_or_cancelled;
            gspc::rpc::sync_remote_function<protocol::running> _running;
          };
