...
namespace
{
  bool compare_workflow_response_result
    ( std::variant<std::exception_ptr, gspc::pnet::type::value::value_type> const& l
    , std::variant<std::exception_ptr, gspc::pnet::type::value::value_type> const& r
    )
  {
    struct visitor
    {
      bool operator() (std::exception_ptr const&, gspc::pnet::type::value::value_type const&) const { return false; }
      bool operator() (gspc::pnet::type::value::value_type const&, std::exception_ptr const&) const { return false; }

      bool operator() ( gspc::pnet::type::value::value_type const& lhs
                      , gspc::pnet::type::value::value_type const& rhs
                      ) const
      {
        return lhs == rhs;
      }
      ...
      {
        //! \note hacky-di-hack
        return gspc::util::serialization::exception::serialize (lhs)
          == gspc::util::serialization::exception::serialize (rhs);
      }
    };
...
#define DEC_IN_PROGRESS(COUNTER)                                \
  ...
  std::unordered_set<gspc::we::layer::id_type> _in_progress_cancels;
...
#define REMOVE_CANCEL_IN_PROGRESS(ID)                           \
  ...
  DECLARE_EXPECT_CLASS ( submit
        ...
        BOOST_PP_COMMA() gspc::we::type::Activity act
                       , _id (id)
        BOOST_PP_COMMA() _act (act)
                       , gspc::we::layer::id_type* _id
                       ; gspc::we::type::Activity _act
                       , id != nullptr && _act == act
                       );

  void submit
    (gspc::we::layer::id_type id, gspc::we::type::Activity act)
  {
  ...
  void cancel (gspc::we::layer::id_type id)
  {
  ...
  void finished ( gspc::we::layer::id_type id
                , gspc::we::type::Activity act
                )
  {
  ...
  void failed (gspc::we::layer::id_type id, std::string message)
  {
  ...
  void canceled (gspc::we::layer::id_type id)
  {
  ...
  DECLARE_EXPECT_CLASS ( token_put
                       ...
                       , gspc::we::layer::id_type _put_token_id
                       , _put_token_id == put_token_id
                       );
  ...
  DECLARE_EXPECT_CLASS ( workflow_response
        ...
        BOOST_PP_COMMA() std::variant<std::exception_ptr BOOST_PP_COMMA() gspc::pnet::type::value::value_type> result
                       , _workflow_response_id (workflow_response_id)
        BOOST_PP_COMMA() _result (result)
                       , gspc::we::layer::id_type _workflow_response_id
                       ; std::variant<std::exception_ptr BOOST_PP_COMMA() gspc::pnet::type::value::value_type> _result
                       , _workflow_response_id == workflow_response_id
  ...
  void do_submit ( gspc::we::layer::id_type id
                 , gspc::we::type::Activity act
                 )
  {
  ...
  void do_finished ( gspc::we::layer::id_type id
                   , gspc::we::type::Activity act
                   )
  {
  ...
  void do_cancel (gspc::we::layer::id_type id)
  {
    ADD_CANCEL_IN_PROGRESS (id);
  ...
  void do_failed (gspc::we::layer::id_type id, std::string message)
  {
    DEC_IN_PROGRESS (jobs_rts);
    REMOVE_CANCEL_IN_PROGRESS (id);
  ...
  void do_canceled (gspc::we::layer::id_type id)
  {
    DEC_IN_PROGRESS (jobs_rts);
    REMOVE_CANCEL_IN_PROGRESS (id);
  ...
  void do_put_token ( gspc::we::layer::id_type id
                    , std::string put_token_id
  ...
  void do_workflow_response ( gspc::we::layer::id_type id
                            , std::string workflow_response_id
                            , std::string place_name
                            , gspc::pnet::type::value::value_type value
                            )
...
BOOST_FIXTURE_TEST_CASE (expressions_shall_not_be_sumitted_to_rts, daemon)
{
  gspc::we::type::Transition transition
    ( "expression"
    , gspc::we::type::Expression ("${out} := ${in} + 1L")
    , std::nullopt
  ...
  activity.add_input ("in", gspc::pnet::type::value::read ("1L"));

  gspc::we::layer::id_type const id (generate_id());

  {
    gspc::we::type::Activity activity_expected (transition);
    activity_expected.add_output_TESTING_ONLY
      ( "out"
      , gspc::pnet::type::value::read ("2L")
      );
...
BOOST_FIXTURE_TEST_CASE (module_calls_should_be_submitted_to_rts, daemon)
{
  ...
  gspc::we::type::Activity activity_output (transition);
  activity_output.add_output_TESTING_ONLY ("out", value::CONTROL);

  gspc::we::type::Activity activity_input (transition);
  activity_input.add_input ("in", value::CONTROL);

  gspc::we::type::Activity activity_child (transition);
  activity_child.add_input ("in", value::CONTROL);

  gspc::we::type::Activity activity_result
    (gspc::we::type::TESTING_ONLY{}, transition, gspc::we::transition_id_type (0));
...

  {
    ...
    gspc::we::layer::id_type child_id;
    {
  ...
  (finished_shall_be_called_after_finished_two_childs, daemon)
{
  ...
  gspc::we::layer::id_type child_id_a;
  gspc::we::layer::id_type child_id_b;
  ...
  (two_interleaving_jobs_shall_be_properly_handled, daemon)
{
  ...
  gspc::we::layer::id_type const id_0 (generate_id());
  gspc::we::layer::id_type const id_1 (generate_id());

  gspc::we::layer::id_type child_id_0_0;
  gspc::we::layer::id_type child_id_0_1;
  gspc::we::layer::id_type child_id_1_0;
  gspc::we::layer::id_type child_id_1_1;
...
namespace
{
  struct cancel_test_daemon : public daemon
  {
    ...
    void test_routine (method first_child, method second_child)
    {
      ...
      auto&& do_method
        ( [&] (gspc::we::layer::id_type const& id_, method how)
          {
            switch (how)
            {
  ...
  (sibling_jobs_shall_be_canceled_on_child_failure_and_any_termination_is_okay, daemon)
{
  ...
  gspc::we::layer::id_type child_id_a;
  gspc::we::layer::id_type child_id_b;
  gspc::we::layer::id_type child_id_c;
  ...
  (finished_shall_be_called_after_finished_N_childs, daemon)
{
  ...
  std::vector<gspc::we::layer::id_type> child_ids (N);
...
BOOST_FIXTURE_TEST_CASE (layer_properly_puts_token, daemon)
{
  ...
  {
    std::string const put_token_id (gspc::testing::random_string());
...
namespace
{
    ...
    wfr_net_with_childs (bool put_on_input)
  {
    ...
    */
    ...
    gspc::pnet::type::signature::structured_type const request_t
      ( std::make_pair
          ( "request_t"
          , gspc::pnet::type::signature::structure_type
    ...
    gspc::we::place_id_type const place_id_mid
      ( net.add_place
          ( gspc::we::type::place::type
              ( "mid"
              , signature::CONTROL
    ...
    gspc::we::place_id_type const place_id_request
      ( net.add_place
          ( gspc::we::type::place::type
              ( "request"
              , request_t
    ...
    gspc::we::type::Transition trans_a
      ( "trans_a"
      , gspc::we::type::ModuleCall
        ( "m"
        , "f"
    ...
    gspc::we::port_id_type const trans_a_port_id_in
      ( trans_a.add_port ( gspc::we::type::Port ( "in"
                                            , gspc::we::type::port::direction::In{}
                                            , signature::CONTROL
                                            , gspc::we::type::property::type()
                                            )
    ...
    gspc::we::port_id_type const trans_a_port_id_out
      ( trans_a.add_port ( gspc::we::type::Port ( "out"
                                            , gspc::we::type::port::direction::Out{}
                                            , signature::CONTROL
                                            , gspc::we::type::property::type()
                                            )
    ...
    gspc::we::type::Transition trans_b
      ( "trans_b"
    ...
    gspc::we::port_id_type const trans_b_port_id_in
      ( trans_b.add_port ( gspc::we::type::Port ( "in"
                                            , gspc::we::type::port::direction::In{}
                                            , signature::CONTROL
                                            , gspc::we::type::property::type()
                                            )
    ...
    gspc::we::port_id_type const trans_b_port_id_out
      ( trans_b.add_port ( gspc::we::type::Port ( "out"
                                            , gspc::we::type::port::direction::Out{}
                                            , signature::CONTROL
                                            , gspc::we::type::property::type()
                                            )
    ...
    gspc::we::port_id_type const trans_b_port_id_request
      ( trans_b.add_port ( gspc::we::type::Port ( "request"
                                            , gspc::we::type::port::direction::In{}
                                            , request_t
                                            , gspc::we::type::property::type()
                                            )
    ...
    gspc::we::port_id_type const trans_b_port_id_response
      ( trans_b.add_port ( gspc::we::type::Port ( "response"
                                            , gspc::we::type::port::direction::Out{}
                                            , signature::LONG
                                            , gspc::we::type::property::type()
                                            )
    ...
    gspc::we::transition_id_type const trans_a_id
      (net.add_transition (trans_a));
    gspc::we::transition_id_type const trans_b_id
...

    {
      ...
      net.add_connection
        (gspc::we::edge::PT{}, trans_a_id, place_id_in, trans_a_port_id_in, empty);
      net.add_connection
        (gspc::we::edge::TP{}, trans_a_id, place_id_mid, trans_a_port_id_out, empty);

      net.add_connection
        (gspc::we::edge::PT{}, trans_b_id, place_id_mid, trans_b_port_id_in, empty);
      net.add_connection
        (gspc::we::edge::PT{}, trans_b_id, place_id_request, trans_b_port_id_request, empty);
      net.add_response
        (trans_b_id, trans_b_port_id_response, "request", empty);
      net.add_connection
        (gspc::we::edge::TP{}, trans_b_id, place_id_out, trans_b_port_id_out, empty);
    }
...
BOOST_FIXTURE_TEST_CASE (workflow_response_works, daemon)
{
  ...
  long const value {gspc::testing::random<long>()()};
...
BOOST_FIXTURE_TEST_CASE (workflow_response_fails_when_workflow_fails, daemon)
{
  ...
  {
    std::string const fail_reason (gspc::testing::random_string());
...
namespace std
{
  template<> struct hash<gspc::we::type::Requirement>
  {
    size_t operator()(gspc::we::type::Requirement const& requirement) const
    {
      size_t seed (0);
...
namespace
{
  gspc::we::place_id_type add_transition_with_requirement_and_input_place
    (gspc::we::type::net_type& net, gspc::we::type::Requirement const& requirement)
  {
    gspc::we::type::Transition transition
      ( gspc::testing::random_string()
      , gspc::we::type::ModuleCall ( gspc::testing::random_string()
                                , gspc::testing::random_string()
                                , std::unordered_map< std::string
                                                    , gspc::we::type::MemoryBufferInfo
                                                    >()
                                , std::list<gspc::we::type::memory_transfer>()
                                , std::list<gspc::we::type::memory_transfer>()
                                , true
    ...
    gspc::we::port_id_type const port_id
    ...
    gspc::we::place_id_type const place_id
      ( net.add_place
          ( gspc::we::type::place::type
              ( port_name
              , std::string ("control")
  ...
  gspc::we::type::Activity net_with_two_childs_that_require_capabilities
    ( gspc::we::type::Requirement const& capability_a
    , std::size_t num_worker_with_capability_a
    , gspc::we::type::Requirement const& capability_b
    ...
    )
  {
...

    {
      ...
      {
        net.put_value (place_id, gspc::we::type::literal::control());
      }
    }
  ...
  public:
    ...
    void submit (gspc::we::type::Activity activity)
    {
      const std::list<gspc::we::type::Requirement> list_req
  ...
  public:
    std::unordered_map<gspc::we::type::Requirement, unsigned int>
      _received_requirements;
...
BOOST_AUTO_TEST_CASE (layer_properly_forwards_requirements)
{
  ...
  const gspc::we::type::Requirement req_a ("A");
  const gspc::we::type::Requirement req_b ("B");
...
namespace
{
  gspc::we::type::MultiModuleCall create_dummy_multi_mod
    (std::list<gspc::we::type::Preference> const& preferences)
  {
    gspc::we::type::MultiModuleCall multi_mod;
  ...
  gspc::we::type::Activity activity_with_preferences
   (std::list<gspc::we::type::Preference> const& preferences)
  {
    gspc::we::type::Transition transition
      ( gspc::testing::random_string()
  ...
  public:
    ...
    void submit (gspc::we::type::Activity const& activity)
    {
    ...
    std::list<gspc::we::type::Preference> received_preferences()
    {
  ...
  private:
    ...
    std::list<gspc::we::type::Preference> _received_preferences;
...
namespace
{
  ...
  gspc::we::type::eureka_id_type const eureka_id_1 ("group1");
  gspc::we::type::eureka_id_type const eureka_id_2 ("group2");
  gspc::we::type::eureka_id_type const eureka_id_3 ("group3");

  struct child_activity_with_eureka
  {
    gspc::we::type::Activity child;
    gspc::we::type::Activity result_eureka;
    gspc::we::type::Activity result_no_eureka;

    child_activity_with_eureka
      ( gspc::we::type::Transition const& t
      , gspc::we::transition_id_type const& t_id
      , std::set<gspc::we::type::eureka_id_type> const& h_set
      )
      : child (gspc::we::type::TESTING_ONLY{}, t, t_id)
      , result_eureka (child)
      , result_no_eureka (child)
    {
      ...
      result_eureka.add_output_TESTING_ONLY
        ( "out"
        , gspc::pnet::type::value::wrap (h_set)
        );
    }
  };
  ...
  struct activity_with_transitions
  {
    ...
    gspc::we::type::Activity input;
    gspc::we::type::Activity output;
    ...
    void add_transition_and_create_child_activity
      ( std::string place_name
      , gspc::we::type::eureka_id_type const eureka_id
      , std::set<gspc::we::type::eureka_id_type> const eurekaed_set
      )
    {
      std::ostringstream oss;
      oss << gspc::pnet::type::value::show (gspc::pnet::type::value::value_type (eureka_id));
      gspc::we::type::Transition transition
        ( "module_call"
        , gspc::we::type::ModuleCall
          ( "m"
      ...
      gspc::we::place_id_type place_id_in
        ( net.add_place
            ( gspc::we::type::place::type
                ( place_name
                , signature::CONTROL
      ...
      gspc::we::transition_id_type transition_id (net.add_transition (transition));
      {
        gspc::we::type::property::type empty;
    ...
    {
      gspc::we::type::net_type copy_of_net_without_inputs (net);

      output = gspc::we::type::Activity
        ( gspc::we::type::Transition ( "net"
    ...
    gspc::we::type::Activity const& get_activity ( std::string name
                                             , activity_type type
                                             )
    {
  ...
  (one_of_two_groups_call_eureka, daemon)
{
  ...
  gspc::we::layer::id_type child_id_A_1;
  gspc::we::layer::id_type child_id_A_2;
  gspc::we::layer::id_type child_id_B_1;
  gspc::we::layer::id_type child_id_B_2;
  gspc::we::layer::id_type child_id_C_1;
  gspc::we::layer::id_type child_id_C_2;
  ...
  (one_of_two_eureka_jobs_call_eureka, daemon)
{
  ...
  gspc::we::layer::id_type const id_A (generate_id());
  gspc::we::layer::id_type const id_B (generate_id());
