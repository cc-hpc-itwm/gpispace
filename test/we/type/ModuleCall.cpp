// Copyright (C) 2015-2016,2018,2020-2023,2026 Fraunhofer ITWM
...
{
  gspc::we::type::ModuleCall const module_call
...
BOOST_AUTO_TEST_CASE (memory_buffer_random_sizes_default_alignments)
{
  std::list<std::string> names
    {gspc::testing::random<unsigned long>()() % 100};
