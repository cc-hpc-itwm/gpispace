// Copyright (C) 2013-2015,2020-2023,2026 Fraunhofer ITWM
...
try
{
  ...
  using gspc::pnet::type::signature::show;
  using gspc::pnet::type::signature::cpp::header;
  using gspc::pnet::type::signature::cpp::header_op;
  using gspc::pnet::type::signature::cpp::impl;
