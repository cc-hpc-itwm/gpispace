// Copyright (C) 2010,2013-2016,2018,2020-2026 Fraunhofer ITWM
...
{
  template<typename T>
  gspc::we::expr::eval::context require_evaluating_to
    (std::string const& expression, T const& value)
  {
    ...
    {
      BOOST_TEST
        (  boost::get<T> (gspc::we::expr::parse::parser (expression).eval_all (context))
        == value
    ...
    {
      BOOST_REQUIRE_EQUAL ( gspc::we::expr::parse::parser (expression).eval_all (context)
...
{
  require_evaluating_to ("", gspc::we::type::literal::control{});
}
...
{
 BOOST_REQUIRE_EQUAL
   ( gspc::we::expr::parse::parser ("").string()
   , gspc::we::expr::parse::parser ("/**/").string()
   );
 BOOST_REQUIRE_EQUAL
   ( gspc::we::expr::parse::parser ("").string()
   , gspc::we::expr::parse::parser ("/* something in between */").string()
   );
}
BOOST_AUTO_TEST_CASE (nested_comment)
{
 ...
 BOOST_REQUIRE_EQUAL
   ( gspc::we::expr::parse::parser ("").string()
   , gspc::we::expr::parse::parser ("/* something at level 1 /**/ */").string()
   );
}
...
{
  BOOST_REQUIRE_EQUAL
   ( gspc::we::expr::parse::parser ("floor ${a}").string()
   , gspc::we::expr::parse::parser ("floor (${a})").string()
   );
}
...
{
  gspc::we::expr::parse::parser parser ("${_}");
  parser.rename ("a", "A");

  BOOST_REQUIRE_EQUAL (parser.string(), gspc::we::expr::parse::parser ("${_}").string());
}

BOOST_AUTO_TEST_CASE (variable_renamed)
{
  gspc::we::expr::parse::parser parser ("${a}");
  parser.rename ("a", "A");

  BOOST_REQUIRE_EQUAL (parser.string(), gspc::we::expr::parse::parser ("${A}").string());
}

BOOST_AUTO_TEST_CASE (first_field_renamed)
{
  gspc::we::expr::parse::parser parser ("${a._}");
  parser.rename ("a", "A");

  BOOST_REQUIRE_EQUAL
    (parser.string(), gspc::we::expr::parse::parser ("${A._}").string());
}

BOOST_AUTO_TEST_CASE (later_field_not_renamed)
{
  gspc::we::expr::parse::parser parser ("${_.a}");
  parser.rename ("a", "A");

  BOOST_REQUIRE_EQUAL
    (parser.string(), gspc::we::expr::parse::parser ("${_.a}").string());
}

BOOST_AUTO_TEST_CASE (renamed_at_depth_greater_zero)
{
  gspc::we::expr::parse::parser parser ("sin (${a})");
  parser.rename ("a", "A");

  BOOST_REQUIRE_EQUAL
    (parser.string(), gspc::we::expr::parse::parser ("sin (${A})").string());
}
...
BOOST_AUTO_TEST_CASE (token_or_integral)
{
  ...
  require_evaluating_to ("0A | 0A", gspc::pnet::type::value::bigint_type (0));
  require_evaluating_to ("0A | 1A", gspc::pnet::type::value::bigint_type (1));
  require_evaluating_to ("1A | 1A", gspc::pnet::type::value::bigint_type (1));
  require_evaluating_to ("1A | 0A", gspc::pnet::type::value::bigint_type (1));
  require_evaluating_to ("1A | 2A", gspc::pnet::type::value::bigint_type (3));
  require_evaluating_to ("2A | 1A", gspc::pnet::type::value::bigint_type (3));
}
...
BOOST_AUTO_TEST_CASE (token_or_short_circuit)
{
  gspc::testing::require_exception
    ...
    , gspc::pnet::exception::missing_binding ("a")
    );

  BOOST_REQUIRE_EQUAL
    ( require_evaluating_to ("false || (${a} := true)", true).value ({"a"})
    , gspc::pnet::type::value::value_type (true)
    );
}
...
BOOST_AUTO_TEST_CASE (token_and_integral)
{
  ...
  require_evaluating_to ("0A & 0A", gspc::pnet::type::value::bigint_type (0));
  require_evaluating_to ("0A & 1A", gspc::pnet::type::value::bigint_type (0));
  require_evaluating_to ("1A & 1A", gspc::pnet::type::value::bigint_type (1));
  require_evaluating_to ("1A & 0A", gspc::pnet::type::value::bigint_type (0));
  require_evaluating_to ("1A & 2A", gspc::pnet::type::value::bigint_type (0));
  require_evaluating_to ("2A & 1A", gspc::pnet::type::value::bigint_type (0));
  require_evaluating_to ("2A & 3A", gspc::pnet::type::value::bigint_type (2));
}
...
BOOST_AUTO_TEST_CASE (token_and_short_circuit)
{
  ...
  BOOST_REQUIRE_EQUAL
    ...
    , gspc::pnet::type::value::value_type (false)
    );
}
...
namespace
{
  ...
  {
    gspc::testing::require_exception
      ([&input]() { (void)gspc::we::expr::parse::parser (input); }, exception);
  }
}
...
#undef CHECK
  ...
  check_compare ("0A", "0A", false, true, false, true);
  check_compare ("0A", "1A", true, true, false, false);
  check_compare ("1A", "0A", false, false, true, true);
  check_equality ("0A", "0A", true);
  check_equality ("0A", "1A", false);
  check_equality ("1A", "0A", false);
  ...
  require_ctor_exception
    ...
    , gspc::pnet::exception::eval ( gspc::we::expr::token::type::eq
                            , gspc::pnet::type::value::read ("Struct [a := 0]")
                            , gspc::pnet::type::value::read ("Struct [b := 0]")
                            )
    );
  require_ctor_exception
    ( "Struct [a:=0] == Struct [a:=0L]"
    , gspc::pnet::exception::eval (gspc::we::expr::token::type::eq, 0, 0L)
    );
}
...
#define SUFFIX(_type, _suffix)                  \
  ...
  SUFFIX (float, "f");
  SUFFIX (double, "");
  SUFFIX (gspc::pnet::type::value::bigint_type, "A");
#undef SUFFIX
    ...
    T parse_showed (T const& x)
  {
    ...
    return ::boost::get<T>
      ( gspc::we::expr::parse::parser {fmt::format ("{:g}{}", x, suffix<T>()())}
      . eval_all (context)
      );
  }
    ...
    T random_real()
  {
    ...
    return number (gspc::testing::detail::GLOBAL_random_engine());
  }
...
BOOST_AUTO_TEST_CASE (token_add)
{
  ...
  require_random_integrals_evaluating_to<gspc::pnet::type::value::bigint_type>
    (std::bind (&check_binop<gspc::pnet::type::value::bigint_type>, "+", &plus<gspc::pnet::type::value::bigint_type>, std::placeholders::_1, std::placeholders::_2));
...
BOOST_AUTO_TEST_CASE (token_mul)
{
  ...
  require_random_integrals_evaluating_to<gspc::pnet::type::value::bigint_type>
    (std::bind (&check_binop<gspc::pnet::type::value::bigint_type>, "*", &product<gspc::pnet::type::value::bigint_type>, std::placeholders::_1, std::placeholders::_2));
  ...
  require_evaluating_to ("1A * 0A", gspc::pnet::type::value::bigint_type (0));
  require_evaluating_to ("1A * 1A", gspc::pnet::type::value::bigint_type (1));
  require_evaluating_to ("1A * 2A", gspc::pnet::type::value::bigint_type (2));
  require_evaluating_to ("2A * 1A", gspc::pnet::type::value::bigint_type (2));
...
BOOST_AUTO_TEST_CASE (token_min)
{
  ...
  require_random_integrals_evaluating_to<gspc::pnet::type::value::bigint_type>
    (std::bind (&check_binop_prefix<gspc::pnet::type::value::bigint_type>, "min", &minimum<gspc::pnet::type::value::bigint_type>, std::placeholders::_1, std::placeholders::_2));
  ...
  require_evaluating_to ("min (0A, 0A)", gspc::pnet::type::value::bigint_type (0));
  require_evaluating_to ("min (0A, 1A)", gspc::pnet::type::value::bigint_type (0));
  require_evaluating_to ("min (1A, 0A)", gspc::pnet::type::value::bigint_type (0));
  require_evaluating_to ("min (1A, 1A)", gspc::pnet::type::value::bigint_type (1));
  require_evaluating_to ("min (1A, 2A)", gspc::pnet::type::value::bigint_type (1));
  require_evaluating_to ("min (2A, 1A)", gspc::pnet::type::value::bigint_type (1));
...
BOOST_AUTO_TEST_CASE (token_max)
{
  ...
  require_random_integrals_evaluating_to<gspc::pnet::type::value::bigint_type>
    (std::bind (&check_binop_prefix<gspc::pnet::type::value::bigint_type>, "max", &maximum<gspc::pnet::type::value::bigint_type>, std::placeholders::_1, std::placeholders::_2));
  ...
  require_evaluating_to ("max (0A, 0A)", gspc::pnet::type::value::bigint_type (0));
  require_evaluating_to ("max (0A, 1A)", gspc::pnet::type::value::bigint_type (1));
  require_evaluating_to ("max (1A, 0A)", gspc::pnet::type::value::bigint_type (1));
  require_evaluating_to ("max (1A, 1A)", gspc::pnet::type::value::bigint_type (1));
  require_evaluating_to ("max (1A, 2A)", gspc::pnet::type::value::bigint_type (2));
  require_evaluating_to ("max (2A, 1A)", gspc::pnet::type::value::bigint_type (2));
...
BOOST_AUTO_TEST_CASE (token_sub)
{
  ...
  require_random_integrals_evaluating_to<gspc::pnet::type::value::bigint_type>
    (std::bind (&check_binop<gspc::pnet::type::value::bigint_type>, "-", &minus<gspc::pnet::type::value::bigint_type>, std::placeholders::_1, std::placeholders::_2));
...
namespace
{
    ...
    )
  {
    ...
    {
      require_ctor_exception
        (expression, gspc::we::expr::exception::eval::divide_by_zero());
    }
  }
}
...
BOOST_AUTO_TEST_CASE (token_divint)
{
  ...
  require_random_integrals_evaluating_to<gspc::pnet::type::value::bigint_type>
    (std::bind (&check_divmod_for_integral<gspc::pnet::type::value::bigint_type>, "div", &quotient<gspc::pnet::type::value::bigint_type>, std::placeholders::_1, std::placeholders::_2));
  ...
  require_evaluating_to ("0A div 1A", gspc::pnet::type::value::bigint_type (0));
  ...
  require_evaluating_to ("1A div 1A", gspc::pnet::type::value::bigint_type (1));
  ...
  require_evaluating_to ("2A div 2A", gspc::pnet::type::value::bigint_type (1));
  ...
  require_evaluating_to ("2A div 1A", gspc::pnet::type::value::bigint_type (2));

  require_ctor_exception
    ("1 div 0", gspc::we::expr::exception::eval::divide_by_zero());
  require_ctor_exception
    ("1U div 0U", gspc::we::expr::exception::eval::divide_by_zero());
  require_ctor_exception
    ("1L div 0L", gspc::we::expr::exception::eval::divide_by_zero());
  require_ctor_exception
    ("1UL div 0UL", gspc::we::expr::exception::eval::divide_by_zero());
  require_ctor_exception
    ("1A div 0A", gspc::we::expr::exception::eval::divide_by_zero());
}
...
BOOST_AUTO_TEST_CASE (token_modint)
{
  ...
  require_random_integrals_evaluating_to<gspc::pnet::type::value::bigint_type>
    (std::bind (&check_divmod_for_integral<gspc::pnet::type::value::bigint_type>, "mod", &remainder<gspc::pnet::type::value::bigint_type>, std::placeholders::_1, std::placeholders::_2));
  ...
  require_evaluating_to ("0A mod 1A", gspc::pnet::type::value::bigint_type (0));
  ...
  require_evaluating_to ("1A mod 1A", gspc::pnet::type::value::bigint_type (0));
  ...
  require_evaluating_to ("2A mod 2A", gspc::pnet::type::value::bigint_type (0));
  ...
  require_evaluating_to ("2A mod 1A", gspc::pnet::type::value::bigint_type (0));
  ...
  require_evaluating_to ("1A mod 2A", gspc::pnet::type::value::bigint_type (1));
  ...
  require_ctor_exception
    ("1 mod 0", gspc::we::expr::exception::eval::divide_by_zero());
  require_ctor_exception
    ("1U mod 0U", gspc::we::expr::exception::eval::divide_by_zero());
  require_ctor_exception
    ("1L mod 0L", gspc::we::expr::exception::eval::divide_by_zero());
  require_ctor_exception
    ("1UL mod 0UL", gspc::we::expr::exception::eval::divide_by_zero());
}
...
namespace
{
  ...
  void check_quotient_for_fractional()
  {
    for (int i (0); i < 100; ++i)
    {
      ...
      T const r_value
        (::boost::get<T> (gspc::we::expr::parse::parser (r).eval_all (context)));

      if (std::abs (r_value) >= std::numeric_limits<T>::min())
      {
        BOOST_REQUIRE_EQUAL
          ( ::boost::get<T>
            (gspc::we::expr::parse::parser (expression). eval_all (context))
          , ::boost::get<T> (gspc::we::expr::parse::parser (l).eval_all (context))
          / r_value
          );
      }
      else
...
BOOST_AUTO_TEST_CASE (token_div)
{
  ...
  require_ctor_exception
    ("1.0 / 0.0", gspc::we::expr::exception::eval::divide_by_zero());
  require_ctor_exception
    ("1.0f / 0.0f", gspc::we::expr::exception::eval::divide_by_zero());
}
...
namespace
{
    ...
    void check_pow_for_fractional()
  {
    for (int i (0); i < 100; ++i)
    {
      ...
      BOOST_REQUIRE_EQUAL
        ( ::boost::get<T>
          ( gspc::we::expr::parse::parser {fmt::format ("{} ** {}", l, r)}
          . eval_all (context)
          )
        , std::pow
          ( ::boost::get<T> (gspc::we::expr::parse::parser (l).eval_all (context))
...
BOOST_AUTO_TEST_CASE (token_pow_int_signed_negative_exponent_throws)
{
  gspc::testing::require_exception
    ( [] { require_evaluating_to ("0 ^ (-1)", 0); }
    , gspc::we::expr::exception::eval::negative_exponent()
    );
  gspc::testing::require_exception
    ( [] { require_evaluating_to ("0L ^ (-1L)", 0L); }
    , gspc::we::expr::exception::eval::negative_exponent()
                                    ...
                                    )
  {
    for (int i (0); i < 100; ++i)
    {
      ...
      BOOST_REQUIRE_EQUAL
        ...
        , operation
          (::boost::get<T> (gspc::we::expr::parse::parser (input).eval_all (context)))
        );
    }
  }
...
BOOST_AUTO_TEST_CASE (token_neg)
{
  ...
  check_unary_for_integral<gspc::pnet::type::value::bigint_type, gspc::pnet::type::value::bigint_type> ("-", &negate<gspc::pnet::type::value::bigint_type>);
}
...
BOOST_AUTO_TEST_CASE (token_abs)
{
  ...
  check_unary_for_integral<gspc::pnet::type::value::bigint_type, gspc::pnet::type::value::bigint_type> ("abs", [] (gspc::pnet::type::value::bigint_type const& x) { return boost::multiprecision::abs (x); });
}
...
namespace
{
  ...
  void check_square_root_for_fractional()
  {
    for (int i (0); i < 100; ++i)
    {
      ...
      gspc::we::expr::eval::context _;

      std::string const expression {fmt::format ("sqrt ({})", input)};

      T const value
        (::boost::get<T> (gspc::we::expr::parse::parser (input).eval_all (_)));

      if (value < 0)
      {
        require_ctor_exception
          ( expression
          , gspc::we::expr::exception::eval::square_root_for_negative_argument<T> (value)
          );
      }
      else
      {
        BOOST_REQUIRE_EQUAL
          ( ::boost::get<T> (gspc::we::expr::parse::parser (expression).eval_all (_))
          , std::sqrt (value)
          );
      }
    }
  ...
  void check_square_root_for_signed_integral()
  {
    ...
    for (int i (0); i < 100; ++i)
    {
      ...
      if (x < 0)
      {
        require_ctor_exception
          ( expression
          , gspc::we::expr::exception::eval::square_root_for_negative_argument<T> (x)
          );
      }
      else
      {
  ...
  void check_logarithm_for_fractional()
  {
    for (int i (0); i < 100; ++i)
    {
      ...
      if (value < 0)
      {
        require_ctor_exception
          ( expression
          , gspc::we::expr::exception::eval::log_for_nonpositive_argument<T> (value)
          );
      }
      else
      {
  ...
  void check_logarithm_for_signed_integral()
  {
    ...
    for (int i (0); i < 100; ++i)
    {
      ...
      if (!(x > 0))
      {
        require_ctor_exception
          ( expression
          , gspc::we::expr::exception::eval::log_for_nonpositive_argument<T> (x)
          );
      }
      else
      {
...
namespace
{
  void check_random_bitsets
    (std::function<void (gspc::pnet::type::bitsetofint::type const&)> check)
  {
    for (int _ (0); _ < 100; ++_)
    {
      gspc::pnet::type::bitsetofint::type bs;

      auto n (gspc::testing::random<unsigned int>{} (100));

      while (n --> 0)
      {
        bs.ins (gspc::testing::random<unsigned long>{} (1UL << 10));
      }
  ...
  ( std::function<void ( gspc::pnet::type::bitsetofint::type const&
                       , gspc::pnet::type::bitsetofint::type const&
                       )
                 > check
  )
  {
    for (int _ (0); _ < 100; ++_)
    {
      gspc::pnet::type::bitsetofint::type bs_l;

      {
        ...
        while (n --> 0)
        {
          bs_l.ins (gspc::testing::random<unsigned long>{} (1UL << 10));
        }
      }

      gspc::pnet::type::bitsetofint::type bs_r;

      {
        ...
        while (n --> 0)
        {
          bs_r.ins (gspc::testing::random<unsigned long>{} (1UL << 10));
        }
      }
...
BOOST_AUTO_TEST_CASE (token_bitset_count)
{
  check_random_bitsets
    ([](gspc::pnet::type::bitsetofint::type const& bs)
    {
      require_evaluating_to
...
BOOST_AUTO_TEST_CASE (token_bitset_logical)
{
  check_random_pairs_of_bitsets
    ([](gspc::pnet::type::bitsetofint::type const& l, gspc::pnet::type::bitsetofint::type const& r)
    {
      require_evaluating_to
...
BOOST_AUTO_TEST_CASE (token_bitset_ins_del_is_elem)
{
  for (int _ (0); _ < 100; ++_)
  {
    ...
    gspc::pnet::type::bitsetofint::type a;
    ...
    while (n --> 0)
    {
      auto const k (gspc::testing::random<unsigned long>{} (1UL << 10));
...
{
  gspc::testing::random<int> number;

  for (int _ (0); _ < 10; ++_)
  {
    std::list<gspc::pnet::type::value::value_type> a;
    std::list<gspc::pnet::type::value::value_type> b;

    require_evaluating_to
      ( fmt::format ("stack_empty ({})", gspc::pnet::type::value::show (a))
      , true
      );

    auto const n (gspc::testing::random<unsigned long>{} (100));
    ...
    {
      require_evaluating_to
        (fmt::format ("stack_size ({})", gspc::pnet::type::value::show (a)), i);
      ...
      require_evaluating_to
        (fmt::format ("stack_top ({})", gspc::pnet::type::value::show (a)), k);
    ...
    {
      require_evaluating_to
        ( fmt::format ("stack_size ({})", gspc::pnet::type::value::show (a))
        , ks.size()
        );

      require_evaluating_to
        ( fmt::format ("stack_top ({})", gspc::pnet::type::value::show (a))
        , ks.top()
        );
      ...
      require_evaluating_to
        (fmt::format ("stack_pop ({})", gspc::pnet::type::value::show (a)), b);
...
BOOST_AUTO_TEST_CASE (token_stack_join)
{
  ...
  for (int _ (0); _ < 10; ++_)
  {
    std::list<gspc::pnet::type::value::value_type> a;
    std::list<gspc::pnet::type::value::value_type> b;
    std::list<gspc::pnet::type::value::value_type> joined;

    auto na (gspc::testing::random<unsigned long>{} (100));
    auto nb (gspc::testing::random<unsigned long>{} (100));
...
{
  gspc::testing::random<int> key;
  gspc::testing::random<long> value;

  for (int _ (0); _ < 10; ++_)
  {
    std::map<gspc::pnet::type::value::value_type, gspc::pnet::type::value::value_type> a;
    std::map<gspc::pnet::type::value::value_type, gspc::pnet::type::value::value_type> b;

    require_evaluating_to
      ( fmt::format ("map_empty ({})", gspc::pnet::type::value::show (a))
      , true
      );
    ...
    {
      require_evaluating_to
        ( fmt::format ("map_size ({})", gspc::pnet::type::value::show (a))
        , a.size()
        );
...
{
  gspc::testing::random<long> number;

  for (int _ (0); _ < 10; ++_)
  {
    std::set<gspc::pnet::type::value::value_type> a;
    std::set<gspc::pnet::type::value::value_type> b;

    require_evaluating_to
      ( fmt::format ("set_empty ({})", gspc::pnet::type::value::show (a))
      , true
      );
    ...
    {
      require_evaluating_to
        ( fmt::format ("set_size ({})",  gspc::pnet::type::value::show (a))
        , a.size()
        );
...
BOOST_AUTO_TEST_CASE (tokens_set_top_pop)
{
  ...
  for (int _ (0); _ < 10; ++_)
  {
    ...
    while (n --> 0)
    {
      ...
      require_evaluating_to
        ( fmt::format ("set_top ({})", gspc::pnet::type::value::show (a))
        , *(a.begin())
        );
    }
    ...
    while (!a.empty())
    {
      ...
      require_evaluating_to
        ( fmt::format ("set_pop ({})", gspc::pnet::type::value::show (a))
        , b
        );
...
{
  std::map<gspc::pnet::type::value::value_type, gspc::pnet::type::value::value_type> m;

  auto const missing_key (gspc::testing::random<int>{}());

  gspc::testing::require_exception
    ( [&]
      {
        (void) gspc::we::expr::parse::parser
          ( fmt::format ( "map_get_assignment ({}, {})"
                        , gspc::pnet::type::value::show (m)
                        , gspc::pnet::type::value::show (missing_key)
                        )
          ).eval_all();
      }
    , gspc::pnet::exception::eval (gspc::we::expr::token::_map_get_assignment, m, missing_key)
    );
}
  ...
  (to_retrieve_non_existing_keys_from_non_empty_map_throws_informative_exception)
{
  ...
  gspc::testing::unique_random<std::string, identifier> uniq_key;
  auto N (gspc::testing::random<std::size_t>{} (1000));
...
{
  BOOST_REQUIRE_EQUAL (true, gspc::we::expr::parse::parser ("true").is_const_true());
  BOOST_REQUIRE_EQUAL (false, gspc::we::expr::parse::parser ("false").is_const_true());

  //! \todo make this evaluate to "true"
  BOOST_REQUIRE_EQUAL
    (false, gspc::we::expr::parse::parser ("${a} :eq: ${a}").is_const_true());

  BOOST_REQUIRE_EQUAL (false, gspc::we::expr::parse::parser ("${a}").is_const_true());
}
...
BOOST_AUTO_TEST_CASE (to_eval_stack_top_of_empty_list_throws_eval_error)
{
  gspc::testing::require_exception
    ( []
      {
        gspc::we::expr::parse::parser ("stack_top (List())").eval_all();
      }
    , gspc::pnet::exception::eval
      ( gspc::we::expr::token::_stack_top
...
BOOST_AUTO_TEST_CASE (to_eval_stack_pop_of_empty_list_throws_eval_error)
{
  gspc::testing::require_exception
    ( []
      {
        gspc::we::expr::parse::parser ("stack_pop (List())").eval_all();
      }
    , gspc::pnet::exception::eval
      ( gspc::we::expr::token::_stack_pop
      , std::list<gspc::pnet::type::value::value_type>{}
      )
    );
}
BOOST_AUTO_TEST_CASE (to_eval_set_top_of_empty_set_throws_eval_error)
{
  gspc::testing::require_exception
    ( []
      {
        gspc::we::expr::parse::parser ("set_top (Set{})").eval_all();
      }
    , gspc::pnet::exception::eval
      ( gspc::we::expr::token::_set_top
...
BOOST_AUTO_TEST_CASE (to_eval_set_pop_of_empty_set_throws_eval_error)
{
  gspc::testing::require_exception
    ( []
      {
        gspc::we::expr::parse::parser ("set_pop (Set{})").eval_all();
      }
    , gspc::pnet::exception::eval
      ( gspc::we::expr::token::_set_pop
      , std::set<gspc::pnet::type::value::value_type>{}
      )
    );
}
...
#define REQUIRE_NODE_IS_VALUE(n,v)                                        \
  gspc::util::visit<void>                                                  \
    ( n                                                                   \
    , [] (gspc::pnet::type::value::value_type const& value)                     \
      {                                                                   \
        BOOST_REQUIRE_EQUAL (value, gspc::pnet::type::value::value_type (v));   \
      }                                                                   \
    , [] (auto const& node)                                               \
      {                                                                   \
        BOOST_FAIL                                                        \
          (  "Expected value " << v << " but got node "                   \
          << gspc::we::expr::parse::node::type (node)                               \
          );                                                              \
      }                                                                   \
    )
...
{
  gspc::we::expr::parse::parser const p ("4 + 5");
...
{
  gspc::we::expr::parse::parser const p
    (gspc::we::expr::parse::parser::DisableConstantFolding{}, "4 + 5");
  ...
  gspc::util::visit<void>
    ( *p.begin()
    , [] (gspc::we::expr::parse::node::binary_t const& b)
      {
        BOOST_REQUIRE_EQUAL (b.token, ::gspc::we::expr::token::add);
    ...
    , [] (auto const& node)
      {
        BOOST_FAIL
          ("Expected '+' but got node " << gspc::we::expr::parse::node::type (node));
      }
    );
}
// Tests for shared value expression syntax
#include <gspc/we/type/shared.hpp>

BOOST_AUTO_TEST_CASE (shared_accepts_string_literal)
{
  auto const p {gspc::we::expr::parse::parser {"shared_cleanup (\"test\")"}};
  auto const result {p.eval_all()};
  auto const& s {boost::get<gspc::we::type::shared> (result)};
  BOOST_REQUIRE_EQUAL (s.cleanup_place(), "cleanup");
  BOOST_REQUIRE_EQUAL
    ( s.value()
    , gspc::pnet::type::value::value_type (std::string {"test"})
    );
}

BOOST_AUTO_TEST_CASE (shared_accepts_integer_literal)
{
  auto const p {gspc::we::expr::parse::parser {"shared_cleanup (42)"}};
  auto const result {p.eval_all()};
  auto const& s {boost::get<gspc::we::type::shared> (result)};
  BOOST_REQUIRE_EQUAL (s.cleanup_place(), "cleanup");
  BOOST_REQUIRE_EQUAL (s.value(), gspc::pnet::type::value::value_type (42));
}

BOOST_AUTO_TEST_CASE (shared_accepts_variable_reference)
{
  auto const p {gspc::we::expr::parse::parser {"shared_cleanup (${x})"}};
  gspc::we::expr::eval::context ctx;
  auto val_x {gspc::pnet::type::value::value_type {std::string {"from_variable"}}};
  ctx.bind_ref ("x", val_x);
  auto const result {p.eval_all (ctx)};
  auto const& s {boost::get<gspc::we::type::shared> (result)};
  BOOST_REQUIRE_EQUAL (s.cleanup_place(), "cleanup");
  BOOST_REQUIRE_EQUAL
    ( s.value()
    , gspc::pnet::type::value::value_type (std::string {"from_variable"})
    );
}

BOOST_AUTO_TEST_CASE (shared_accepts_expression)
{
  auto const p {gspc::we::expr::parse::parser {"shared_cleanup (${a} + ${b})"}};
  gspc::we::expr::eval::context ctx;
  auto val_a {gspc::pnet::type::value::value_type {10}};
  auto val_b {gspc::pnet::type::value::value_type {32}};
  ctx.bind_ref ("a", val_a);
  ctx.bind_ref ("b", val_b);
  auto const result {p.eval_all (ctx)};
  auto const& s {boost::get<gspc::we::type::shared> (result)};
  BOOST_REQUIRE_EQUAL (s.cleanup_place(), "cleanup");
  BOOST_REQUIRE_EQUAL (s.value(), gspc::pnet::type::value::value_type (42));
...
BOOST_AUTO_TEST_CASE (shared_stringifies_correctly)
{
  {
    auto const p {gspc::we::expr::parse::parser {"shared_cleanup (\"test\")"}};
    BOOST_REQUIRE_EQUAL (p.string(), "shared_cleanup (\"test\");");
  }
  {
    auto const p
      { gspc::we::expr::parse::parser
        { gspc::we::expr::parse::parser::DisableConstantFolding{}
        , "shared_cleanup (${x})"
        }
      };
    BOOST_REQUIRE_EQUAL (p.string(), "shared_cleanup (${x});");
  }
}

BOOST_AUTO_TEST_CASE (shared_can_be_nested)
{
  auto const p {gspc::we::expr::parse::parser {"shared_outer (shared_inner (42))"}};
  BOOST_REQUIRE_EQUAL (p.string(), "shared_outer (shared_inner (42));");
}
