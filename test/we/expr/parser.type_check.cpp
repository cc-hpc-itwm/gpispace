...
#include <unordered_map>
  ...
  namespace gspc::we::expr::type
  {
    namespace
    {
      struct Expression : gspc::util::ostream::modifier
      {
        template<typename E>
        ...
        gspc::we::expr::parse::node::type const& last() const
        {
          auto pos (_ast.begin());
        ...
        std::string expression() const
        {
          ...
          oss << gspc::pnet::type::value::show (_ast.eval_all());
          return oss.str();
        }
...
{
  template<>
    struct formatter<gspc::we::expr::type::Expression> : fmt::ostream_formatter
  {};
}
  ...
  namespace gspc::we::expr::type
  {
    namespace
    {
      ...
      template<> struct RandomT<double>
      {
        ...
        gspc::testing::random<int> _random_int;
      };

      template< typename T
              , typename Generator = RandomT<T>
              >
        struct RandomExpression : public gspc::util::ostream::modifier
      {
      ...
      namespace
      {
        ...
        {
          using Generator = gspc::testing::random<std::string>;
      ...
      template<> struct RandomT<gspc::pnet::type::value::bigint_type>
      {
        auto operator()() const -> gspc::pnet::type::value::bigint_type { return _gen(); }
        gspc::testing::random<gspc::pnet::type::value::bigint_type> _gen;
      };
      template<> RandomExpression<gspc::pnet::type::value::bigint_type> random_expression<gspc::pnet::type::value::bigint_type>()
      {
        return "{}a";
      }
    }
...
{
  template<typename T>
    struct formatter<gspc::we::expr::type::RandomExpression<T>> : fmt::ostream_formatter
  {};
}
  ...
  namespace gspc::we::expr::type
  {
    namespace
    {
      namespace
      {
        std::string random_bitset()
        {
          ...
          return Expression (gspc::pnet::type::value::show (bs)).expression();
        }
        std::string random_bytearray()
        {
          gspc::testing::random<std::string> rand_string;

          return Expression
            (gspc::pnet::type::value::show (gspc::we::type::bytearray (rand_string()))).expression();
        }
      }
        ...
        gspc::testing::require_exception
          ...
          , gspc::testing::make_nested
            ( exception::type::error
              { fmt::format ( "In '{}'"
                            , gspc::we::expr::parse::node::type {expression.last()}
      ...
      std::vector<TypeAndValue> const types_and_values_random
        ...
        , {Bigint{}, random_expression<gspc::pnet::type::value::bigint_type>().string()}
    ...
    BOOST_AUTO_TEST_CASE (min)
    {
      ...
      require_type_to ("min (0A, 0A)", Bigint{});
    ...
    BOOST_AUTO_TEST_CASE (max)
    {
      ...
      require_type_to ("max (0A, 0A)", Bigint{});
    ...
    BOOST_AUTO_TEST_CASE (or_integral)
    {
      ...
      require_type_to ("0A | 0A", Bigint{});
      require_type_to ("0A | 1A", Bigint{});
      require_type_to ("1A | 1A", Bigint{});
      require_type_to ("1A | 0A", Bigint{});
      require_type_to ("1A | 2A", Bigint{});
      require_type_to ("2A | 1A", Bigint{});
    }
...
#undef CHECK
      ...
      type_check_compare_ops ("0A", "0A");
      type_check_compare_ops ("0A", "1A");
      type_check_compare_ops ("1A", "0A");
      type_check_equality_ops ("0A", "0A");
      type_check_equality_ops ("0A", "1A");
      type_check_equality_ops ("1A", "0A");
    ...
    BOOST_AUTO_TEST_CASE (token_min)
    {
      ...
      require_type_to ("min (0A, 0A)", Bigint{});
      require_type_to ("min (0A, 1A)", Bigint{});
      require_type_to ("min (1A, 0A)", Bigint{});
      require_type_to ("min (1A, 1A)", Bigint{});
      require_type_to ("min (1A, 2A)", Bigint{});
      require_type_to ("min (2A, 1A)", Bigint{});
    ...
    BOOST_AUTO_TEST_CASE (token_max)
    {
      ...
      require_type_to ("max (0A, 0A)", Bigint{});
      require_type_to ("max (0A, 1A)", Bigint{});
      require_type_to ("max (1A, 0A)", Bigint{});
      require_type_to ("max (1A, 1A)", Bigint{});
      require_type_to ("max (1A, 2A)", Bigint{});
      require_type_to ("max (2A, 1A)", Bigint{});
    ...
    BOOST_AUTO_TEST_CASE (token_divint)
    {
      ...
      require_type_to ("0A div 1A", Bigint{});
      require_type_to ("1A div 1A", Bigint{});
      require_type_to ("2A div 2A", Bigint{});
      require_type_to ("2A div 1A", Bigint{});
    }
    ...
    BOOST_AUTO_TEST_CASE (token_modint)
    {
      ...
      require_type_to ("0A mod 1A", Bigint{});
      require_type_to ("1A mod 1A", Bigint{});
      require_type_to ("2A mod 2A", Bigint{});
      require_type_to ("2A mod 1A", Bigint{});
      require_type_to ("1A mod 2A", Bigint{});
      require_type_to ("5A mod 3A", Bigint{});
    }
    ...
    BOOST_AUTO_TEST_CASE (token_abs)
    {
      ...
      require_type_to ("abs (-42A)", Bigint{});
    }
        ...
        ( fmt::format
            ...
            , gspc::util::join
              ( std::vector<std::string>
                  (gspc::testing::random<int>{} (100, 1), tv.value())
              , ", "
              )
            )
        , Boolean{}
      ...
      )
    {
      ...
      require_type_to (random_math_func<gspc::pnet::type::value::bigint_type> (cast_func), casted_type);
    }
      ...
      )
    {
      require_inference_exception
        ...
        , exception::type::error
          { fmt::format
            ( "argument '{1}' of '{0}' has type '{2}' but is not of kind 'Number' == {{'int', 'long', 'unsigned int', 'unsigned long', 'float', 'double', 'bigint'}}"
            , cast_func_type.cast_func()
      ...
      )
    {
      require_inference_exception
        ...
        , exception::type::error
          { fmt::format
            ( "left argument '{1}' of ' {0} ' has type '{2}' but is not of kind 'Number' == {{'int', 'long', 'unsigned int', 'unsigned long', 'float', 'double', 'bigint'}}"
            , op
            , Expression (lhs.value())
            , lhs.type()
            )
      ...
      )
    {
      require_inference_exception
        ...
        , exception::type::error
          { fmt::format
            ( "right argument '{1}' of ' {0} ' has type '{2}' but is not of kind 'Number' == {{'int', 'long', 'unsigned int', 'unsigned long', 'float', 'double', 'bigint'}}"
            , op
            , Expression (rhs.value())
            , rhs.type()
            )
      ...
      )
    {
      require_inference_exception
        ...
        , exception::type::error
          { fmt::format
            ( "left argument '{1}' of ' {0} ' has type '{2}' but is not of kind 'Integer' == {{'int', 'long', 'unsigned int', 'unsigned long', 'bigint'}}"
            , op
            , Expression (lhs.value())
            , lhs.type()
            )
      ...
      )
    {
      require_inference_exception
        ...
        , exception::type::error
          { fmt::format
            ( "right argument '{1}' of ' {0} ' has type '{2}' but is not of kind 'Integer' == {{'int', 'long', 'unsigned int', 'unsigned long', 'bigint'}}"
            , op
            , Expression (rhs.value())
            , rhs.type()
            )
      ...
      )
    {
      require_inference_exception
        ...
        , gspc::testing::make_nested
          ( exception::type::error
            { fmt::format
              ( "gspc::we::expr::type::Context::bind (${{s}}, '{0}')"
              , x.type()
              )
            }
          , exception::type::error
