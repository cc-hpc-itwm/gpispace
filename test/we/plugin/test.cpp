...
#include <string>
    ...
    namespace gspc::we::plugin
    {
      namespace
      {
        ...
        {
          FPlugins()
            : value (gspc::testing::random<long>{}())
            , tag (gspc::testing::random<std::string>{}())
...
#define UNEXPECTED()                                                    \
        [&] (std::string _tag, gspc::pnet::type::value::value_type _value)    \
        {                                                               \
          BOOST_FAIL                                                    \
            ( "UNEXPECTED "                                             \
            << "(" << _tag                                              \
            << ", " << gspc::pnet::type::value::show (_value)                 \
            << ")"                                                      \
            );                                                          \
        }
