// Copyright (C) 2013-2016,2020,2023,2026 Fraunhofer ITWM
...
#define SIG_LITERAL(_s,_v...) SIG (std::string (_s), _v)
  ...
  SIG_LITERAL ("bitset", gspc::pnet::type::bitsetofint::type());
  SIG_LITERAL ("bytearray", gspc::we::type::bytearray());
