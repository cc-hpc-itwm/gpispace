// Copyright (C) 2016,2019-2023,2025-2026 Fraunhofer ITWM
...
#include <test/we/net.common.hpp>
  ...
  namespace gspc::we::type
  {
    BOOST_AUTO_TEST_CASE (scalability_in_countdown)
    {
      ...
      net.add_connection (gspc::we::edge::PT{}, d, p, in, no_properties());
      net.add_connection (gspc::we::edge::TP{}, d, p, out, no_properties());
      net.add_connection (gspc::we::edge::PT{}, e, p, x, no_properties());
      ...
      {
        net.put_value (p, gspc::pnet::type::value::value_type (n));
        ...
        BOOST_REQUIRE_EQUAL ( net.get_token (p).begin()->second
                            , gspc::pnet::type::value::value_type (n)
                            );
...
#undef CHECK
    ...
    BOOST_AUTO_TEST_CASE (partial_cross_product_uses_referenced_places_only)
    {
          ...
          )
      {
        ...
        auto add_place
          ( [&] ( std::string name
                , gspc::pnet::type::signature::signature_type signature
                )
            {
        ...
        net.add_connection (gspc::we::edge::PT{}, tid, pid_x, port_x, no_properties());
        net.add_connection (gspc::we::edge::PT{}, tid, pid_y, port_y, no_properties());
