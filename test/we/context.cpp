...
{
  using context_t = gspc::we::expr::eval::context;
  using value_type = gspc::pnet::type::value::value_type;
...

  {
    ...
    c.bind_and_discard_ref ({"z","x"}, gspc::pnet::type::value::value_type (z_x_new));
...

  {
    ...
    c.bind_and_discard_ref ({"z"}, gspc::pnet::type::value::value_type (z_new));
