// Copyright (C) 2014-2016,2020-2021,2023-2024,2026 Fraunhofer ITWM
...
BOOST_AUTO_TEST_CASE (share_example_map_log)
{
  ...
  gspc::util::temporary_path const shared_directory
    (gspc::testing::shared_directory (vm) / "share_example_map_log");
  ...
  std::multimap<std::string, gspc::pnet::type::value::value_type> const result
    ( gspc::client (drts).put_and_run
      ...
      , { {"input", allocation_input.global_memory_range()}
        ...
        , {"user_data", gspc::pnet::type::value::read (user_data)}
