...
{
  GSPC_TESTING_REQUIRE_PRINTED_AS ("multimap []", std::multimap<std::string, int>{});
  GSPC_TESTING_REQUIRE_PRINTED_AS ("multimap []", std::multimap<int, int>{});
  GSPC_TESTING_REQUIRE_PRINTED_AS ("multimap []", std::multimap<float, int>{});
}
