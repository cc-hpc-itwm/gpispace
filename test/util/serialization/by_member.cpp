#include <gspc/util/serialization/by_member.hpp>
...
FHG_UTIL_SERIALIZATION_BY_MEMBER
  ( gspc::util::serialization::order_checker
  , gspc::util::serialization::base_class<gspc::util::serialization::member<-1>>()
  , &gspc::util::serialization::order_checker::_0
  , &gspc::util::serialization::order_checker::_2
  , &gspc::util::serialization::order_checker::_1
  , gspc::util::serialization::base_class<gspc::util::serialization::member<-2>>()
  )
