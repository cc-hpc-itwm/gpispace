...
BOOST_AUTO_TEST_CASE (std_exceptions)
{
  ...
  REQUIRE_ID (std::logic_error, gspc::testing::random<std::string>{}());
  REQUIRE_ID (std::domain_error, gspc::testing::random<std::string>{}());
  REQUIRE_ID (std::future_error, std::future_errc::future_already_retrieved);
  REQUIRE_ID (std::invalid_argument, gspc::testing::random<std::string>{}());
  REQUIRE_ID (std::length_error, gspc::testing::random<std::string>{}());
  REQUIRE_ID (std::out_of_range, gspc::testing::random<std::string>{}());
  REQUIRE_ID (std::runtime_error, gspc::testing::random<std::string>{}());
  REQUIRE_ID (std::overflow_error, gspc::testing::random<std::string>{}());
  REQUIRE_ID (std::range_error, gspc::testing::random<std::string>{}());
  ...
  // REQUIRE_ID (std::ios_base::failure, gspc::testing::random<std::string>{}());
  REQUIRE_ID (std::underflow_error, gspc::testing::random<std::string>{}());
}
...
BOOST_AUTO_TEST_CASE (nested)
{
  ...
  std::string const inner {gspc::testing::random<std::string>{}()};
  std::string const outer {gspc::testing::random<std::string>{}()};
  try
  {
    try
    {
    ...
    ( [&]
      {
        std::rethrow_exception
          ( gspc::util::serialization::exception::deserialize
              (gspc::util::serialization::exception::serialize (ex))
          );
      }
...
BOOST_AUTO_TEST_CASE (user_defined)
{
  ...
  REQUIRE_ID (user_defined_exception, functions, gspc::testing::random<int>{}());
  REQUIRE_ID (user_defined_std_logic_error, functions, gspc::testing::random<int>{}());
}
...
{
  gspc::util::serialization::exception::serialization_functions const functions
    ( { gspc::util::serialization::exception::make_functions<with_boost_serialization>()
      , gspc::util::serialization::exception::make_functions<with_boost_serialization_std_exception>()
      , gspc::util::serialization::exception::make_functions<with_boost_serialization_std_logic_error>()
      , gspc::util::serialization::exception::make_functions<with_static_functions>()
      , gspc::util::serialization::exception::make_functions<with_static_functions_std_exception>()
      , gspc::util::serialization::exception::make_functions<with_static_functions_std_logic_error>()
      , gspc::util::serialization::exception::make_functions<with_to_from_string>()
      , gspc::util::serialization::exception::make_functions<with_to_from_string_std_exception>()
      , gspc::util::serialization::exception::make_functions<with_to_from_string_std_logic_error>()
      , gspc::util::serialization::exception::make_functions<with_serialize_deserialize_with_archive>()
      , gspc::util::serialization::exception::make_functions<with_serialize_deserialize_with_archive_std_exception>()
      , gspc::util::serialization::exception::make_functions<with_serialize_deserialize_with_archive_std_logic_error>()
      }
    );

  REQUIRE_ID (with_boost_serialization, functions, gspc::testing::random<int>{}());
  REQUIRE_ID (with_boost_serialization_std_exception, functions, gspc::testing::random<int>{}());
  REQUIRE_ID (with_boost_serialization_std_logic_error, functions, gspc::testing::random<int>{}());
  REQUIRE_ID (with_static_functions, functions, gspc::testing::random<int>{}());
  REQUIRE_ID (with_static_functions_std_exception, functions, gspc::testing::random<int>{}());
  REQUIRE_ID (with_static_functions_std_logic_error, functions, gspc::testing::random<int>{}());
  REQUIRE_ID (with_to_from_string, functions, gspc::testing::random<int>{}());
  REQUIRE_ID (with_to_from_string_std_exception, functions, gspc::testing::random<int>{}());
  REQUIRE_ID (with_to_from_string_std_logic_error, functions, gspc::testing::random<int>{}());
  REQUIRE_ID (with_serialize_deserialize_with_archive, functions, gspc::testing::random<int>{}());
  REQUIRE_ID (with_serialize_deserialize_with_archive_std_exception, functions, gspc::testing::random<int>{}());
  REQUIRE_ID (with_serialize_deserialize_with_archive_std_logic_error, functions, gspc::testing::random<int>{}());
}
