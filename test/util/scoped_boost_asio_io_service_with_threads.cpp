...
{
  gspc::util::scoped_boost_asio_io_service_with_threads io_service (0);
                     ...
                     )
{
  ...
  gspc::util::latch called (thread_count);
  gspc::util::latch release (1);
                     ...
                     )
{
  gspc::testing::require_exception
    ( []
      {
        gspc::util::scoped_boost_asio_io_service_with_threads_and_deferred_startup io_service (0);
      }
                     ...
                     )
{
  ...
  gspc::util::latch called (thread_count - 1);
  gspc::util::latch release (1);
