...
{
  auto visitor ( gspc::util::make_visitor<bool> ( [] (A) { return true; }
                                               , [] (B) { return false; }
                                               )
               );

  BOOST_REQUIRE (gspc::util::visit<bool> (A_or_B (A()), visitor));
...
{
  BOOST_REQUIRE ( gspc::util::visit<bool> ( A_or_B (A())
                                         , [] (A) { return true; }
                                         , [] (B) { return false; }
                                         )
                );
  BOOST_REQUIRE ( gspc::util::visit<bool> ( A_or_B (B())
                                         , [] (A) { return false; }
                                         , [] (B) { return true; }
                                         )
                );
...
{
  auto visitor ( gspc::util::make_visitor<bool>
                   ( [] (::boost::variant<A, B> const&) { return true; }
                   , [] (C) { return false; }
                   )
               );

  BOOST_REQUIRE (gspc::util::visit<bool> (A_or_B_or_C (A()), visitor));
  BOOST_REQUIRE (gspc::util::visit<bool> (A_or_B_or_C (B()), visitor));
  BOOST_REQUIRE (!gspc::util::visit<bool> (A_or_B_or_C (C()), visitor));
}
...
{
  BOOST_REQUIRE (gspc::util::visit<bool> (A_or_B (A()), is_T<A>()));

  BOOST_REQUIRE ( gspc::util::visit<bool> ( A_or_B_or_C (A())
                                         , is_T<A>()
                                         , [] (C) { return false; }
                                         )
                );
  BOOST_REQUIRE ( gspc::util::visit<bool> ( A_or_B_or_C (C())
                                         , is_T<A>()
                                         , [] (C) { return true; }
                                         )
                );
  ...
  namespace gspc::util
  {
    ...
    BOOST_AUTO_TEST_CASE (allows_modifying_visited_object)
    {
      ...
      gspc::util::visit<void> (x, [] (D& d) { d.visited = true; }, [] {});
