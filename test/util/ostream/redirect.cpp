...
BOOST_AUTO_TEST_CASE (redirect_cout_to_vector)
{
  ...
  gspc::util::ostream::redirect const redirecter
    ( std::cout
...
BOOST_AUTO_TEST_CASE (recursive_redirect)
{
  ...
  gspc::util::ostream::redirect const outer
    ( oss
    , [&oss] (std::string const& line_outer)
      {
        gspc::util::ostream::redirect const inner
          ( oss
...
BOOST_AUTO_TEST_CASE (redirect_to_redirected_stream)
{
  ...
  gspc::util::ostream::redirect const cerr_to_oss
    ( std::cerr
  ...
  gspc::util::ostream::redirect const cout_to_cerr
    ( std::cout
...
BOOST_AUTO_TEST_CASE (prepender_function_of_line)
{
  ...
  gspc::util::ostream::prepend_line const prepender
    ( oss
    , [] (std::string const& line)
      {
...
BOOST_AUTO_TEST_CASE (prepender_const)
{
  ...
  gspc::util::ostream::prepend_line const prepender (oss, prefix);
