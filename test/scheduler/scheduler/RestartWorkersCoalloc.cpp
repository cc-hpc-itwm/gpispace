// Copyright (C) 2014-2016,2018-2024,2026 Fraunhofer ITWM
  ...
  )
{
  ...
  gspc::util::threadsafe_queue<std::string> job_submitted_0;
  ...
  gspc::util::threadsafe_queue<std::string> job_submitted_to_restarted_worker;
...
namespace
{
  ...
  public:
    ...
    {
      _network.perform<gspc::scheduler::events::CancelJobAckEvent> (_agent_address, job_id);
    }

  private:
    std::function<void (std::string)> _announce_cancel;
    gspc::com::p2p::address_t _agent_address;
  ...
  )
{
  ...
  gspc::util::threadsafe_queue<std::string> job_submitted_0;
  gspc::util::threadsafe_queue<std::string> cancel_requested_0;
