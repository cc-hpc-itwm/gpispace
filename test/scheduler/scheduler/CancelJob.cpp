// Copyright (C) 2011,2013-2016,2018-2026 Fraunhofer ITWM
...
namespace
{
  ...
  public:
    ...
    void canceled (std::string name)
    {
      ...
      _network.perform<gspc::scheduler::events::CancelJobAckEvent> (job._owner, job._id);
    }
    ...
    bool cancellation_was_triggered_by_owners()
    {
      return std::all_of
        ...
        , []
          ( std::pair<gspc::com::p2p::address_t, gspc::com::p2p::address_t>
  ...
  private:
    ...
    std::list<std::pair<gspc::com::p2p::address_t, gspc::com::p2p::address_t>>
      _sources_and_owners;
  ...
  )
{
  ...
  const gspc::scheduler::job_id_t job_id
    ( client.submit_job
        ( utils::module_call
  ...
  BOOST_REQUIRE_EQUAL
    (client.wait_for_terminal_state (job_id), gspc::scheduler::status::CANCELED);
}
  ...
  )
{
  ...
  const gspc::scheduler::job_id_t job_id_1
    ( client.submit_job
        ( utils::module_call
            ( gspc::testing::random_string()
            , might_have_tasks_requiring_multiple_workers
  ...
  BOOST_REQUIRE_EQUAL
    (client.wait_for_terminal_state (job_id_1), gspc::scheduler::status::CANCELED);
}
