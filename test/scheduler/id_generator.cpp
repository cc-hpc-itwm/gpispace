// Copyright (C) 2010,2014-2016,2018,2021-2024,2026 Fraunhofer ITWM
...
BOOST_AUTO_TEST_CASE (threaded_unique_set_of_id_throws_on_duplicate)
{
  ...
  std::string const id (gspc::testing::random_string_without_zero());
...
namespace
{
  void generator_is_unique_with_n_threads (std::size_t num_threads)
  {
    ...
    gspc::scheduler::id_generator id_generator (gspc::testing::random_string_without_zero());
    threaded_unique_set_of_id ids;
