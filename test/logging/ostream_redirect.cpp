// Copyright (C) 2018,2022-2023,2025-2026 Fraunhofer ITWM
// SPDX-License-Identifier: GPL-3.0-or-later

#include <gspc/logging/ostream_redirect.hpp>
...
#include <string>
  ...
  namespace gspc::logging
  {
    BOOST_AUTO_TEST_CASE (invokes_underlying_emitters_method)
    {
      ...
      auto const choice
        (gspc::testing::random<std::size_t>{}() % ostream_choices.size());
    ...
    {
      auto const content (gspc::testing::random_string_without ("\n"));
    ...
    {
      auto const category (gspc::testing::random<std::string>{}());
