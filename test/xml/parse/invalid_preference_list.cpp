...
#include <test/xml/parse/preference_list_with_modules_helpers.hpp>
...
namespace
{
  ...
  {
    return
      gspc::testing::random_char_of
      ("!@#$%^&*(){}:\"'/.,\\")
      +
      gspc::testing::random_string_of
...
BOOST_AUTO_TEST_CASE (parse_preference_list_with_duplicates)
{
  ...
  gspc::testing::require_exception_with_message
    <gspc::xml::parse::error::duplicate_preference>
      ( [&state, &input]
        {
...
BOOST_AUTO_TEST_CASE (parse_empty_preference_list)
{
  ...
  gspc::testing::require_exception_with_message
    <gspc::xml::parse::error::empty_preferences>
      ( [&state, &input]
        {
          std::istringstream input_stream (input);
          gspc::xml::parse::just_parse (state, input_stream);
...
BOOST_AUTO_TEST_CASE (parse_preference_list_with_invalid_identifier)
{
  ...
  gspc::testing::require_exception_with_message
    <gspc::xml::parse::error::invalid_name>
      ( [&state, &input]
        {
          std::istringstream input_stream (input);
          gspc::xml::parse::just_parse (state, input_stream);
                     ...
                     )
{
  ...
  gspc::testing::require_exception_with_message
    <gspc::xml::parse::error::preferences_without_modules>
      ( [&state, &input]
        {
          std::istringstream input_stream (input);
          gspc::xml::parse::just_parse (state, input_stream);
...
BOOST_AUTO_TEST_CASE (parse_multi_modules_with_a_module_without_target)
{
  ...
  std::list<gspc::xml::parse::type::preference_type> test_targets
  ...
  gspc::testing::require_exception_with_message
    <gspc::xml::parse::error::missing_target_for_module>
...
BOOST_AUTO_TEST_CASE (parse_multi_modules_with_duplicate_module_targets)
{
  ...
  auto const mod_name (gspc::testing::random_identifier());
  ...
  gspc::testing::require_exception_with_message
    <gspc::xml::parse::error::duplicate_module_for_target>
...
BOOST_AUTO_TEST_CASE (parse_multi_modules_without_preferences)
{
  ...
  gspc::testing::require_exception_with_message
    <gspc::xml::parse::error::modules_without_preferences>
      ( [&state, &pnet_no_pref]
        {
          std::istringstream input_stream
...
namespace
{
  ...
  {
    std::list<gspc::xml::parse::type::preference_type> preferences;
    std::list<gspc::xml::parse::type::preference_type> modules;
    std::list<gspc::xml::parse::type::preference_type> no_modules;
    std::list<gspc::xml::parse::type::preference_type> no_preferences;

    mismatching_targets()
    {
      std::list<gspc::xml::parse::type::preference_type> targets;
      do
      {
      ...
      auto const split_a
        (gspc::testing::random<std::size_t>{} (targets.size() - 1, 1));
      auto const split_b
        (gspc::testing::random<std::size_t>{} (split_a));

      auto it_a = gspc::util::next ( targets.begin()
                                  , split_a
                                  );

      auto it_b = gspc::util::next ( targets.begin()
                                  , split_b
                                  );

      preferences = std::list<gspc::xml::parse::type::preference_type>
                    ( targets.begin()
                    , it_a
                    );

      modules = std::list<gspc::xml::parse::type::preference_type>
                ( it_b
                , targets.end()
                );

      no_modules = std::list<gspc::xml::parse::type::preference_type>
                   ( targets.begin()
                   , it_b
                   );

      no_preferences = std::list<gspc::xml::parse::type::preference_type>
                  ( it_a
                  , targets.end()
                  );
    }
...
BOOST_AUTO_TEST_CASE (parse_multi_modules_with_non_empty_mismatching_preferences)
{
  ...
  gspc::testing::require_exception_with_message
    <gspc::xml::parse::error::mismatching_modules_and_preferences>
      ( [&state, &multi_mod]
        {
          std::istringstream input_stream
            (multi_mod.pnet_xml);
