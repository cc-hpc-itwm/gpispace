// Copyright (C) 2014-2016,2018,2020-2021,2023-2026 Fraunhofer ITWM
...
namespace
{
  ...
  {
    using impl = gspc::testing::random<std::string>;
...
<defun>
  ...
  <expression/>
    ...
    gspc::testing::require_exception_with_message
      <gspc::xml::parse::error::memory_buffer_without_size>
      ( [&state, &input]()
...
{
  std::string const name (random_identifier_with_valid_prefix());
  std::string const size (gspc::testing::random_content_string());
...
<defun>
  ...
  <expression/>
    ...
    gspc::testing::require_exception_with_message
      <gspc::xml::parse::error::duplicate_memory_buffer>
      ( [&state, &input]()
      { std::istringstream input_stream (input);
        gspc::xml::parse::just_parse (state, input_stream);
      }
...
BOOST_AUTO_TEST_CASE (memory_buffers_are_stored_in_function)
{
  ...
  std::string const size_1 (gspc::testing::random_content_string());
  std::string const name_2 (names());
  std::string const size_2 (gspc::testing::random_content_string());
...
<defun>
  ...
  <module name="{4}" function="{5}"/>
    ...
    BOOST_REQUIRE_EQUAL
      (function.memory_buffers().get (name_1)->get().size(), size_1);
    BOOST_REQUIRE_EQUAL
      (function.memory_buffers().get (name_2)->get().size(), size_2);
}
...
namespace
{
  ...
  {
    std::string const name_function (gspc::testing::random_identifier());
...
<defun name="{0}">
  ...
  <{1}/>
    ...
    gspc::testing::require_exception_with_message
      <gspc::xml::parse::error::memory_buffer_for_non_module>
      ( [&state, &input]()
      { std::istringstream input_stream (input);
        gspc::xml::parse::just_parse (state, input_stream);
      }
      , fmt::format ( "ERROR: non module call function 'Just {0}'"
...
<defun name="{0}">
  ...
  <{1}/>
    ...
    gspc::testing::require_exception_with_message_in
      <gspc::xml::parse::error::memory_buffer_for_non_module>
      ( [&state, &input]()
      { std::istringstream input_stream (input);
        gspc::xml::parse::just_parse (state, input_stream);
...
<defun>
  ...
  <module name="{2}" function="{3}"/>
    ...
    gspc::testing::require_exception_with_message
      <gspc::xml::parse::error::memory_buffer_with_same_name_as_port>
      ( [&state, &input]()
      { std::istringstream input_stream (input);
        gspc::xml::parse::just_parse (state, input_stream);
      }
...
<defun>
  ...
  <module name="" function="{1} ({0})"/>
    ...
    BOOST_REQUIRE ( gspc::util::cxx17::holds_alternative<gspc::xml::parse::type::module_type>
                    (function.content())
                  );

    gspc::xml::parse::type::module_type const& module_call
